      SUBROUTINE ML5_0_1_1_GOLEMLOOP(NLOOPLINE,PL,M2L,RANK,RES,STABLE)
C     
...
C      NLOOPLINE < 6.
C     
C     Process: g g > ha WEIGHTED<=20 [ noborn = QCD ]
C     
C     
C     MODULES
C     
...
C      GOLEM_RUN_MODE = 3
      ...
      COMMON/ML5_0_1_1_COEF_CHECK_THRS/COEF_CHECK_THRS
...
C     
      COMPLEX(KI) ML5_0_1_1_GOLEM_LOOPNUM
      EXTERNAL ML5_0_1_1_GOLEM_LOOPNUM
      LOGICAL ML5_0_1_1_COMPARE_COEFS_0
      LOGICAL ML5_0_1_1_COMPARE_COEFS_1
      LOGICAL ML5_0_1_1_COMPARE_COEFS_2
      LOGICAL ML5_0_1_1_COMPARE_COEFS_3
      LOGICAL ML5_0_1_1_COMPARE_COEFS_4
      LOGICAL ML5_0_1_1_COMPARE_COEFS_5
      LOGICAL ML5_0_1_1_COMPARE_COEFS_6
C     
C     GLOBAL VARIABLES
C     
      INCLUDE 'coupl.inc'
...
C      limits.
      CALL ML5_0_1_1_SETUP_KIN_MATRIX(NLOOPLINE,PGOLEM,M2LGOLEM)
...
C     Fill in the golem coefficents and compute the loop
      IF(GOLEM_RUN_MODE.EQ.2)THEN
        RES_GOLEM = EVALUATE_B(ML5_0_1_1_GOLEM_LOOPNUM,PGOLEM,0,RANK)
      ELSE
        PASS_COEF_CHECK=.TRUE.
        SELECT CASE(RANK)
        CASE(0)
        CALL ML5_0_1_1_FILL_GOLEM_COEFFS_0(LOOPCOEFS(0,ID),COEFFS0)
        IF(GOLEM_RUN_MODE.EQ.3)THEN
          COEFFS0_REC = ML5_0_1_1_GOLEM_LOOPNUM(NULL_VEC,0.0_KI)
          PASS_COEF_CHECK=ML5_0_1_1_COMPARE_COEFS_0(COEFFS0
     $     ,COEFFS0_REC)
        ENDIF
        CASE(1)
        CALL ML5_0_1_1_FILL_GOLEM_COEFFS_1(LOOPCOEFS(0,ID),COEFFS1)
        IF(GOLEM_RUN_MODE.EQ.3)THEN
          CALL RECONSTRUCT1(ML5_0_1_1_GOLEM_LOOPNUM,COEFFS1_REC)
          PASS_COEF_CHECK=ML5_0_1_1_COMPARE_COEFS_1(COEFFS1
     $     ,COEFFS1_REC)
        ENDIF
        CASE(2)
        CALL ML5_0_1_1_FILL_GOLEM_COEFFS_2(LOOPCOEFS(0,ID),COEFFS2)
        IF(GOLEM_RUN_MODE.EQ.3)THEN
          CALL RECONSTRUCT2(ML5_0_1_1_GOLEM_LOOPNUM,COEFFS2_REC)
          PASS_COEF_CHECK=ML5_0_1_1_COMPARE_COEFS_2(COEFFS2
     $     ,COEFFS2_REC)
        ENDIF
        CASE(3)
        CALL ML5_0_1_1_FILL_GOLEM_COEFFS_3(LOOPCOEFS(0,ID),COEFFS3)
        IF(GOLEM_RUN_MODE.EQ.3)THEN
          CALL RECONSTRUCT3(ML5_0_1_1_GOLEM_LOOPNUM,COEFFS3_REC)
          PASS_COEF_CHECK=ML5_0_1_1_COMPARE_COEFS_3(COEFFS3
     $     ,COEFFS3_REC)
        ENDIF
        CASE(4)
        CALL ML5_0_1_1_FILL_GOLEM_COEFFS_4(LOOPCOEFS(0,ID),COEFFS4)
        IF(GOLEM_RUN_MODE.EQ.3)THEN
          CALL RECONSTRUCT4(ML5_0_1_1_GOLEM_LOOPNUM,COEFFS4_REC)
          PASS_COEF_CHECK=ML5_0_1_1_COMPARE_COEFS_4(COEFFS4
     $     ,COEFFS4_REC)
        ENDIF
        CASE(5)
        CALL ML5_0_1_1_FILL_GOLEM_COEFFS_5(LOOPCOEFS(0,ID),COEFFS5)
        IF(GOLEM_RUN_MODE.EQ.3)THEN
          CALL RECONSTRUCT5(ML5_0_1_1_GOLEM_LOOPNUM,COEFFS5_REC)
          PASS_COEF_CHECK=ML5_0_1_1_COMPARE_COEFS_5(COEFFS5
     $     ,COEFFS5_REC)
        ENDIF
        CASE(6)
        CALL ML5_0_1_1_FILL_GOLEM_COEFFS_6(LOOPCOEFS(0,ID),COEFFS6)
        IF(GOLEM_RUN_MODE.EQ.3)THEN
          CALL RECONSTRUCT6(ML5_0_1_1_GOLEM_LOOPNUM,COEFFS6_REC)
          PASS_COEF_CHECK=ML5_0_1_1_COMPARE_COEFS_6(COEFFS6
     $     ,COEFFS6_REC)
        ENDIF
        CASE DEFAULT
...
C     Finally free golem memory and cache
      ...
      FUNCTION ML5_0_1_1_GOLEM_LOOPNUM(Q,MU2)
      USE PRECISION_GOLEM, ONLY: KI
      ...
      CALL ML5_0_1_1_LOOPNUM(QQ,NUM)
      ML5_0_1_1_GOLEM_LOOPNUM=NUM
      RETURN
      END FUNCTION

      SUBROUTINE ML5_0_1_1_INITGOLEM()
C     
...
C     or everything but the R2
      ...
      SUBROUTINE ML5_0_1_1_SETUP_KIN_MATRIX(NLOOPLINE,PGOLEM,M2L)
C     
C     MODULE
C     
      USE MATRICE_S
...
C     ----------
      ...
      CALL ML5_0_1_1_BUILD_KINEMATIC_MATRIX(NLOOPLINE,PGOLEM,M2L
     $ ,S_MAT_FROM_MG)
      ...
      FUNCTION ML5_0_1_1_COMPARE_COEFS_0(COEFS_A,COEFS_B)
      ...
      IF(DENOM.GT.0D0)THEN
        ML5_0_1_1_COMPARE_COEFS_0=((NUM/DENOM).LT.COEF_CHECK_THRS)
      ELSE
        ML5_0_1_1_COMPARE_COEFS_0=(NUM.LT.COEF_CHECK_THRS)
      ENDIF

      END

      FUNCTION ML5_0_1_1_COMPARE_COEFS_1(COEFS_A,COEFS_B)
     ...
     $ )
      ...
      IF(DENOM.GT.0D0)THEN
        ML5_0_1_1_COMPARE_COEFS_1=((NUM/DENOM).LT.COEF_CHECK_THRS)
      ELSE
        ML5_0_1_1_COMPARE_COEFS_1=(NUM.LT.COEF_CHECK_THRS)
      ENDIF

      END

      FUNCTION ML5_0_1_1_COMPARE_COEFS_2(COEFS_A,COEFS_B)
     ...
     $ )+SUM(ABS(COEFS_A%C2+COEFS_B%C2))
      IF(DENOM.GT.0D0)THEN
        ML5_0_1_1_COMPARE_COEFS_2=((NUM/DENOM).LT.COEF_CHECK_THRS)
      ELSE
        ML5_0_1_1_COMPARE_COEFS_2=(NUM.LT.COEF_CHECK_THRS)
      ENDIF

      END

      FUNCTION ML5_0_1_1_COMPARE_COEFS_3(COEFS_A,COEFS_B)
     ...
     $ )
      IF(DENOM.GT.0D0)THEN
        ML5_0_1_1_COMPARE_COEFS_3=((NUM/DENOM).LT.COEF_CHECK_THRS)
      ELSE
        ML5_0_1_1_COMPARE_COEFS_3=(NUM.LT.COEF_CHECK_THRS)
      ENDIF

      END

      FUNCTION ML5_0_1_1_COMPARE_COEFS_4(COEFS_A,COEFS_B)
     ...
     $ )+SUM(ABS(COEFS_A%C4+COEFS_B%C4))
      IF(DENOM.GT.0D0)THEN
        ML5_0_1_1_COMPARE_COEFS_4=((NUM/DENOM).LT.COEF_CHECK_THRS)
      ELSE
        ML5_0_1_1_COMPARE_COEFS_4=(NUM.LT.COEF_CHECK_THRS)
      ENDIF

      END

      FUNCTION ML5_0_1_1_COMPARE_COEFS_5(COEFS_A,COEFS_B)
     ...
     $ )+SUM(ABS(COEFS_A%C4+COEFS_B%C4))
      IF(DENOM.GT.0D0)THEN
        ML5_0_1_1_COMPARE_COEFS_5=((NUM/DENOM).LT.COEF_CHECK_THRS)
      ELSE
        ML5_0_1_1_COMPARE_COEFS_5=(NUM.LT.COEF_CHECK_THRS)
      ENDIF

      END

      FUNCTION ML5_0_1_1_COMPARE_COEFS_6(COEFS_A,COEFS_B)
     ...
     $ )+SUM(ABS(COEFS_A%C4+COEFS_B%C4))
      IF(DENOM.GT.0D0)THEN
        ML5_0_1_1_COMPARE_COEFS_6=((NUM/DENOM).LT.COEF_CHECK_THRS)
      ELSE
        ML5_0_1_1_COMPARE_COEFS_6=(NUM.LT.COEF_CHECK_THRS)
      ENDIF

      END


      SUBROUTINE ML5_0_1_1_FILL_GOLEM_COEFFS_0(ML_COEFS,GOLEM_COEFS)
      USE PRECISION_GOLEM, ONLY: KI
      ...
      SUBROUTINE ML5_0_1_1_FILL_GOLEM_COEFFS_1(ML_COEFS,GOLEM_COEFS)
...
C     Coefficient q(3)
      ...
      SUBROUTINE ML5_0_1_1_FILL_GOLEM_COEFFS_2(ML_COEFS,GOLEM_COEFS)
...
C     Coefficient q(2)*q(3)
      ...
      SUBROUTINE ML5_0_1_1_FILL_GOLEM_COEFFS_3(ML_COEFS,GOLEM_COEFS)
...
C     Coefficient q(1)*q(2)*q(3)
      ...
      SUBROUTINE ML5_0_1_1_FILL_GOLEM_COEFFS_4(ML_COEFS,GOLEM_COEFS)
      USE TENS_REC, ONLY: COEFF_TYPE_4
      INCLUDE 'coef_specs.inc'
      INCLUDE 'loop_max_coefs.inc'
      COMPLEX*16 ML_COEFS(0:LOOPMAXCOEFS-1)
      TYPE(COEFF_TYPE_4) GOLEM_COEFS
C     Dummy routine for ML5_0_1_1_FILL_GOLEM_COEFS_4
      STOP 'ERROR: 4 > 3'
      END

      SUBROUTINE ML5_0_1_1_FILL_GOLEM_COEFFS_5(ML_COEFS,GOLEM_COEFS)
      USE TENS_REC, ONLY: COEFF_TYPE_5
      INCLUDE 'coef_specs.inc'
      INCLUDE 'loop_max_coefs.inc'
      COMPLEX*16 ML_COEFS(0:LOOPMAXCOEFS-1)
      TYPE(COEFF_TYPE_5) GOLEM_COEFS
C     Dummy routine for ML5_0_1_1_FILL_GOLEM_COEFS_5
      STOP 'ERROR: 5 > 3'
      END

      SUBROUTINE ML5_0_1_1_FILL_GOLEM_COEFFS_6(ML_COEFS,GOLEM_COEFS)
      USE TENS_REC, ONLY: COEFF_TYPE_6
      INCLUDE 'coef_specs.inc'
      INCLUDE 'loop_max_coefs.inc'
      COMPLEX*16 ML_COEFS(0:LOOPMAXCOEFS-1)
      TYPE(COEFF_TYPE_6) GOLEM_COEFS
C     Dummy routine for ML5_0_1_1_FILL_GOLEM_COEFS_6
      STOP 'ERROR: 6 > 3'
      END
