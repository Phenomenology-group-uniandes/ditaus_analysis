...
C      reading the parameters
     ...
     $ ,FORCED_CHOICE_OF_COLLIER_IR_POLE_COMPUTATION/.FALSE.,.FALSE./
      COMMON/ML5_0_1_1_COLLIERPOLESFORCEDCHOICE
...
C         Handle the possible requirement of specific polarizations
     ...
     $     .EQ.0.AND.(.NOT.ML5_0_1_1_IS_HEL_SELECTED(H))) THEN
            CYCLE
          ENDIF
          ...
          IF (DIRECT_ME_COMPUTATION) THEN
            DO I=1,NLOOPAMPS
              DO J=1,NLOOPAMPS
                ...
                ITEMP =
     $            ML5_0_1_1_ML5SQSOINDEX(ML5_0_1_1_ML5SOINDEX_FOR_LOOP_
     $AMP(I),ML5_0_1_1_ML5SOINDEX_FOR_LOOP_AMP(J))
...
C                out this helicity
     ...
     $           -1.OR.ML5_0_1_1_IS_HEL_SELECTED(H)) THEN
...
C                out this helicity
     ...
     $           -1.OR.ML5_0_1_1_IS_HEL_SELECTED(H)) THEN
                  CALL
     $              ML5_0_1_1_COMPUTE_COLOR_FLOWS_DERIVED_QUANTITIES(HE
     $L_MULT)
                ENDIF
              ENDIF
            ENDIF
...
C          this helicity
          IF (POLARIZATIONS(0,0).EQ.
     $     -1.OR.ML5_0_1_1_IS_HEL_SELECTED(HELPICKED)) THEN
...
C     
 ...
 1009   CONTINUE
     ...
     $ //' ML5_0_1_1_ML5SOINDEX_FOR_SQUARED_ORDERS'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      INTEGER FUNCTION ML5_0_1_1_GETORDPOWFROMINDEX_ML5(IORDER, INDX)
C     
...
C     
      ...
      ML5_0_1_1_GETORDPOWFROMINDEX_ML5=SQPLITORDERS(INDX, IORDER)
...
C     
      ...
      DATA (LOOPAMPORDERS(I),I=  1,  4) /    1,    1,    1,    1/
C     -----------
C     BEGIN CODE
C     -----------
...
C     
      ...
      WRITE(*,*) 'ERROR:: Stopping function'
     $ //' ML5_0_1_1_ML5GET_SQUARED_ORDERS_FOR_SOINDEX'
...
C     
      ...
      WRITE(*,*) 'ERROR:: Stopping function'
     $ //' ML5_0_1_1_ML5GET_ORDERS_FOR_AMPSOINDEX'
...
C     
 ...
 1009   CONTINUE
      ...
      WRITE(*,*) 'ERROR:: Stopping function'
     $ //' ML5_0_1_1_ML5SOINDEX_FOR_AMPORDERS'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
