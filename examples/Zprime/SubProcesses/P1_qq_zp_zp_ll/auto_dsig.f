...
C     
C     Process: u u~ > zp WEIGHTED<=1 @1
C     *   Decay: zp > ta+ ta- WEIGHTED<=1
C     Process: u c~ > zp WEIGHTED<=1 @1
C     *   Decay: zp > ta+ ta- WEIGHTED<=1
C     Process: c u~ > zp WEIGHTED<=1 @1
C     *   Decay: zp > ta+ ta- WEIGHTED<=1
C     Process: c c~ > zp WEIGHTED<=1 @1
C     *   Decay: zp > ta+ ta- WEIGHTED<=1
C     Process: d d~ > zp WEIGHTED<=1 @1
C     *   Decay: zp > ta+ ta- WEIGHTED<=1
C     Process: s s~ > zp WEIGHTED<=1 @1
C     *   Decay: zp > ta+ ta- WEIGHTED<=1
C     Process: b b~ > zp WEIGHTED<=1 @1
C     *   Decay: zp > ta+ ta- WEIGHTED<=1
C     
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        ...
        ENDIF
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! u u~ > ta+ ta-
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! u c~ > ta+ ta-
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! c u~ > ta+ ta-
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! c c~ > ta+ ta-
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! d d~ > ta+ ta-
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! s s~ > ta+ ta-
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! b b~ > ta+ ta-
      ENDIF
