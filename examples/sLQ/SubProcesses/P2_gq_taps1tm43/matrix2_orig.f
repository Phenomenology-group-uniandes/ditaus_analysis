...
C     
C     Process: g s > ta+ s1tm43 WEIGHTED<=2 @2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL FFV1_2(W(1,2),W(1,1),GC_12,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFS3C1_0(W(1,5),W(1,3),W(1,4),GC_66,AMP(1))
      CALL VSS1_2(W(1,1),W(1,4),GC_11,MDL_MS1T, ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFS3C1_0(W(1,2),W(1,3),W(1,5),GC_66,AMP(2))
