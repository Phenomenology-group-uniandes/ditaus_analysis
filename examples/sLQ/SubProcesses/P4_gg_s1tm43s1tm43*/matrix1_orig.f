...
C     
C     Process: g g > s1tm43 s1tm43* WEIGHTED<=2 @4
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL VVSS1_0(W(1,1),W(1,2),W(1,4),W(1,3),GC_13,AMP(1))
      CALL VVSS1_0(W(1,1),W(1,2),W(1,4),W(1,3),GC_13,AMP(2))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_10,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VSS1_0(W(1,5),W(1,4),W(1,3),GC_11,AMP(3))
      CALL VSS1_2(W(1,1),W(1,3),GC_11,MDL_MS1T, ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VSS1_0(W(1,2),W(1,4),W(1,5),GC_11,AMP(4))
      CALL VSS1_3(W(1,1),W(1,4),GC_11,MDL_MS1T, ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL VSS1_0(W(1,2),W(1,5),W(1,3),GC_11,AMP(5))
