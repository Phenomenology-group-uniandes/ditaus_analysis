...
C     
C     Process: d d~ > s1tm43 s1tm43* WEIGHTED<=2 @4
C     Process: s s~ > s1tm43 s1tm43* WEIGHTED<=2 @4
C     Process: d s~ > s1tm43 s1tm43* WEIGHTED<=2 @4
C     Process: s d~ > s1tm43 s1tm43* WEIGHTED<=2 @4
C     Process: u u~ > s1tm43 s1tm43* WEIGHTED<=2 @4
C     Process: c c~ > s1tm43 s1tm43* WEIGHTED<=2 @4
C     
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        ...
        ENDIF
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! d d~ > s1tm43 s1tm43*
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! s s~ > s1tm43 s1tm43*
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! d s~ > s1tm43 s1tm43*
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! s d~ > s1tm43 s1tm43*
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! u u~ > s1tm43 s1tm43*
      ENDIF
