...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL FFV1P0_3(W(1,1),W(1,2),GC_12,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VSS1_0(W(1,5),W(1,4),W(1,3),GC_11,AMP(1))
      CALL FFS3C1_2(W(1,1),W(1,3),GC_64,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFS1C1_0(W(1,5),W(1,2),W(1,4),GC_64,AMP(2))
      CALL FFS3C1_2(W(1,1),W(1,3),GC_65,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFS1C1_0(W(1,5),W(1,2),W(1,4),GC_65,AMP(3))
      CALL FFS3C1_2(W(1,1),W(1,3),GC_66,MDL_MTA, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFS1C1_0(W(1,5),W(1,2),W(1,4),GC_66,AMP(4))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = (-1.666666666666667D-01)*AMP(1)
      JAMP(2,1) = (5.000000000000000D-01)*AMP(1)+AMP(2)+AMP(3)+AMP(4)
