...
C     
C     Process: d d~ > ta+ ta- QCD=0 QED=0 @1
C     Process: d s~ > ta+ ta- QCD=0 QED=0 @1
C     Process: d b~ > ta+ ta- QCD=0 QED=0 @1
C     Process: s d~ > ta+ ta- QCD=0 QED=0 @1
C     Process: s s~ > ta+ ta- QCD=0 QED=0 @1
C     Process: s b~ > ta+ ta- QCD=0 QED=0 @1
C     Process: d~ b > ta+ ta- QCD=0 QED=0 @1
C     Process: s~ b > ta+ ta- QCD=0 QED=0 @1
C     Process: b b~ > ta+ ta- QCD=0 QED=0 @1
C     
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        ...
        ENDIF
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! d d~ > ta+ ta-
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! d s~ > ta+ ta-
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! d b~ > ta+ ta-
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! s d~ > ta+ ta-
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! s s~ > ta+ ta-
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! s b~ > ta+ ta-
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! d~ b > ta+ ta-
        IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! s~ b > ta+ ta-
        IF(IPROC.EQ.9) DSIGPROC=DSIG9(P1,WGT,IMODE)  ! b b~ > ta+ ta-
      ENDIF
