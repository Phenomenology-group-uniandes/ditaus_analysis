...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
        IF(MDL_WVLQ.NE.0D0) FK_MDL_WVLQ = SIGN(MAX(ABS(MDL_WVLQ),
     $    ABS(MDL_MVLQ*SMALL_WIDTH_TREATMENT)), MDL_WVLQ)
      ...
      CALL FFV2_3_3(W(1,1),W(1,4),GC_18,GC_19,MDL_MVLQ, ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV2_3_0(W(1,3),W(1,2),W(1,5),GC_18,GC_19,AMP(1))
