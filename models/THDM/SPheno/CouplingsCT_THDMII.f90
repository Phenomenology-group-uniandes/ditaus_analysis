...
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZA(gt3,2)*ZA(gt1,1)*ZA(gt2,1))
res = res+(Lam5*vu*dZA(gt3,1)*ZA(gt1,2)*ZA(gt2,1))/2._dp
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZA(gt3,1)*ZA(gt1,2)*ZA(gt2,1))
res = res-1._dp/2._dp*(Lam5*vd*dZA(gt3,2)*ZA(gt1,2)*ZA(gt2,1))
res = res+(vd*Conjg(Lam5)*dZA(gt3,2)*ZA(gt1,2)*ZA(gt2,1))/2._dp
res = res+(Lam5*vu*dZA(gt3,1)*ZA(gt1,1)*ZA(gt2,2))/2._dp
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZA(gt3,1)*ZA(gt1,1)*ZA(gt2,2))
res = res-1._dp/2._dp*(Lam5*vd*dZA(gt3,2)*ZA(gt1,1)*ZA(gt2,2))
res = res+(vd*Conjg(Lam5)*dZA(gt3,2)*ZA(gt1,1)*ZA(gt2,2))/2._dp
res = res-1._dp/2._dp*(Lam5*vd*dZA(gt3,1)*ZA(gt1,2)*ZA(gt2,2))
res = res+(vd*Conjg(Lam5)*dZA(gt3,1)*ZA(gt1,2)*ZA(gt2,2))/2._dp
res = res+(Lam5*vu*dZA(gt2,2)*ZA(gt1,1)*ZA(gt3,1))/2._dp
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZA(gt2,2)*ZA(gt1,1)*ZA(gt3,1))
res = res+(Lam5*vu*dZA(gt2,1)*ZA(gt1,2)*ZA(gt3,1))/2._dp
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZA(gt2,1)*ZA(gt1,2)*ZA(gt3,1))
res = res-1._dp/2._dp*(Lam5*vd*dZA(gt2,2)*ZA(gt1,2)*ZA(gt3,1))
res = res+(vd*Conjg(Lam5)*dZA(gt2,2)*ZA(gt1,2)*ZA(gt3,1))/2._dp
res = res+(Lam5*vu*dZA(gt1,2)*ZA(gt2,1)*ZA(gt3,1))/2._dp
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZA(gt1,2)*ZA(gt2,1)*ZA(gt3,1))
res = res+(dvu*Lam5*ZA(gt1,2)*ZA(gt2,1)*ZA(gt3,1))/2._dp
res = res+(dLam5*vu*ZA(gt1,2)*ZA(gt2,1)*ZA(gt3,1))/2._dp
res = res-1._dp/2._dp*(vu*Conjg(dLam5)*ZA(gt1,2)*ZA(gt2,1)*ZA(gt3,1))
res = res-1._dp/2._dp*(dvu*Conjg(Lam5)*ZA(gt1,2)*ZA(gt2,1)*ZA(gt3,1))
res = res+(Lam5*vu*dZA(gt1,1)*ZA(gt2,2)*ZA(gt3,1))/2._dp
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZA(gt1,1)*ZA(gt2,2)*ZA(gt3,1))
res = res-1._dp/2._dp*(Lam5*vd*dZA(gt1,2)*ZA(gt2,2)*ZA(gt3,1))
...
res = res-1._dp/2._dp*(vu*Conjg(dLam5)*ZA(gt1,1)*ZA(gt2,2)*ZA(gt3,1))
res = res-1._dp/2._dp*(dvu*Conjg(Lam5)*ZA(gt1,1)*ZA(gt2,2)*ZA(gt3,1))
res = res-1._dp/2._dp*(dvd*Lam5*ZA(gt1,2)*ZA(gt2,2)*ZA(gt3,1))
res = res-1._dp/2._dp*(dLam5*vd*ZA(gt1,2)*ZA(gt2,2)*ZA(gt3,1))
...
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZA(gt2,1)*ZA(gt1,1)*ZA(gt3,2))
res = res-1._dp/2._dp*(Lam5*vd*dZA(gt2,2)*ZA(gt1,1)*ZA(gt3,2))
res = res+(vd*Conjg(Lam5)*dZA(gt2,2)*ZA(gt1,1)*ZA(gt3,2))/2._dp
res = res-1._dp/2._dp*(Lam5*vd*dZA(gt2,1)*ZA(gt1,2)*ZA(gt3,2))
res = res+(vd*Conjg(Lam5)*dZA(gt2,1)*ZA(gt1,2)*ZA(gt3,2))/2._dp
res = res+(Lam5*vu*dZA(gt1,1)*ZA(gt2,1)*ZA(gt3,2))/2._dp
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZA(gt1,1)*ZA(gt2,1)*ZA(gt3,2))
res = res-1._dp/2._dp*(Lam5*vd*dZA(gt1,2)*ZA(gt2,1)*ZA(gt3,2))
...
res = res-1._dp/2._dp*(vu*Conjg(dLam5)*ZA(gt1,1)*ZA(gt2,1)*ZA(gt3,2))
res = res-1._dp/2._dp*(dvu*Conjg(Lam5)*ZA(gt1,1)*ZA(gt2,1)*ZA(gt3,2))
res = res-1._dp/2._dp*(dvd*Lam5*ZA(gt1,2)*ZA(gt2,1)*ZA(gt3,2))
res = res-1._dp/2._dp*(dLam5*vd*ZA(gt1,2)*ZA(gt2,1)*ZA(gt3,2))
res = res+(vd*Conjg(dLam5)*ZA(gt1,2)*ZA(gt2,1)*ZA(gt3,2))/2._dp
res = res+(dvd*Conjg(Lam5)*ZA(gt1,2)*ZA(gt2,1)*ZA(gt3,2))/2._dp
res = res-1._dp/2._dp*(Lam5*vd*dZA(gt1,1)*ZA(gt2,2)*ZA(gt3,2))
res = res+(vd*Conjg(Lam5)*dZA(gt1,1)*ZA(gt2,2)*ZA(gt3,2))/2._dp
res = res-1._dp/2._dp*(dvd*Lam5*ZA(gt1,1)*ZA(gt2,2)*ZA(gt3,2))
res = res-1._dp/2._dp*(dLam5*vd*ZA(gt1,1)*ZA(gt2,2)*ZA(gt3,2))
...
res = 0._dp 
res = res-2*Lam1*vd*dZH(gt3,1)*ZA(gt1,1)*ZA(gt2,1)
...
res = res-1._dp/2._dp*(Lam5*vu*dZH(gt3,1)*ZA(gt1,2)*ZA(gt2,1))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZH(gt3,1)*ZA(gt1,2)*ZA(gt2,1))
res = res-1._dp/2._dp*(Lam5*vd*dZH(gt3,2)*ZA(gt1,2)*ZA(gt2,1))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZH(gt3,2)*ZA(gt1,2)*ZA(gt2,1))
res = res-1._dp/2._dp*(Lam5*vu*dZH(gt3,1)*ZA(gt1,1)*ZA(gt2,2))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZH(gt3,1)*ZA(gt1,1)*ZA(gt2,2))
res = res-1._dp/2._dp*(Lam5*vd*dZH(gt3,2)*ZA(gt1,1)*ZA(gt2,2))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZH(gt3,2)*ZA(gt1,1)*ZA(gt2,2))
...
res = res-2*Lam2*vu*dZH(gt3,2)*ZA(gt1,2)*ZA(gt2,2)
res = res-2*Lam1*vd*dZA(gt2,1)*ZA(gt1,1)*ZH(gt3,1)
res = res-1._dp/2._dp*(Lam5*vu*dZA(gt2,2)*ZA(gt1,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZA(gt2,2)*ZA(gt1,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(Lam5*vu*dZA(gt2,1)*ZA(gt1,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZA(gt2,1)*ZA(gt1,2)*ZH(gt3,1))
...
res = res-2*Lam1*vd*dZA(gt1,1)*ZA(gt2,1)*ZH(gt3,1)
res = res-1._dp/2._dp*(Lam5*vu*dZA(gt1,2)*ZA(gt2,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZA(gt1,2)*ZA(gt2,1)*ZH(gt3,1))
res = res-2*dvd*Lam1*ZA(gt1,1)*ZA(gt2,1)*ZH(gt3,1)
res = res-2*dLam1*vd*ZA(gt1,1)*ZA(gt2,1)*ZH(gt3,1)
res = res-1._dp/2._dp*(dvu*Lam5*ZA(gt1,2)*ZA(gt2,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(dLam5*vu*ZA(gt1,2)*ZA(gt2,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(vu*Conjg(dLam5)*ZA(gt1,2)*ZA(gt2,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(dvu*Conjg(Lam5)*ZA(gt1,2)*ZA(gt2,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(Lam5*vu*dZA(gt1,1)*ZA(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZA(gt1,1)*ZA(gt2,2)*ZH(gt3,1))
...
res = res-1._dp/2._dp*(dvu*Lam5*ZA(gt1,1)*ZA(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(dLam5*vu*ZA(gt1,1)*ZA(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(vu*Conjg(dLam5)*ZA(gt1,1)*ZA(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(dvu*Conjg(Lam5)*ZA(gt1,1)*ZA(gt2,2)*ZH(gt3,1))
...
res = res-1._dp/2._dp*(Lam5*vd*dZA(gt2,2)*ZA(gt1,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZA(gt2,2)*ZA(gt1,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(Lam5*vd*dZA(gt2,1)*ZA(gt1,2)*ZH(gt3,2))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZA(gt2,1)*ZA(gt1,2)*ZH(gt3,2))
res = res-2*Lam2*vu*dZA(gt2,2)*ZA(gt1,2)*ZH(gt3,2)
...
res = res-1._dp/2._dp*(Lam5*vd*dZA(gt1,2)*ZA(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZA(gt1,2)*ZA(gt2,1)*ZH(gt3,2))
...
res = res-1._dp/2._dp*(dvd*Lam5*ZA(gt1,2)*ZA(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(dLam5*vd*ZA(gt1,2)*ZA(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(vd*Conjg(dLam5)*ZA(gt1,2)*ZA(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(dvd*Conjg(Lam5)*ZA(gt1,2)*ZA(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(Lam5*vd*dZA(gt1,1)*ZA(gt2,2)*ZH(gt3,2))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZA(gt1,1)*ZA(gt2,2)*ZH(gt3,2))
res = res-2*Lam2*vu*dZA(gt1,2)*ZA(gt2,2)*ZH(gt3,2)
res = res-1._dp/2._dp*(dvd*Lam5*ZA(gt1,1)*ZA(gt2,2)*ZH(gt3,2))
res = res-1._dp/2._dp*(dLam5*vd*ZA(gt1,1)*ZA(gt2,2)*ZH(gt3,2))
res = res-1._dp/2._dp*(vd*Conjg(dLam5)*ZA(gt1,1)*ZA(gt2,2)*ZH(gt3,2))
res = res-1._dp/2._dp*(dvd*Conjg(Lam5)*ZA(gt1,1)*ZA(gt2,2)*ZH(gt3,2))
res = res-2*dvu*Lam2*ZA(gt1,2)*ZA(gt2,2)*ZH(gt3,2)
res = res-2*dLam2*vu*ZA(gt1,2)*ZA(gt2,2)*ZH(gt3,2)
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZH(gt3,2)*ZA(gt1,1)*ZH(gt2,1))
res = res-1._dp/2._dp*(Lam5*vu*dZH(gt3,1)*ZA(gt1,2)*ZH(gt2,1))
res = res+(vu*Conjg(Lam5)*dZH(gt3,1)*ZA(gt1,2)*ZH(gt2,1))/2._dp
res = res-1._dp/2._dp*(Lam5*vd*dZH(gt3,2)*ZA(gt1,2)*ZH(gt2,1))
res = res+(vd*Conjg(Lam5)*dZH(gt3,2)*ZA(gt1,2)*ZH(gt2,1))/2._dp
res = res+(Lam5*vu*dZH(gt3,1)*ZA(gt1,1)*ZH(gt2,2))/2._dp
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZH(gt3,1)*ZA(gt1,1)*ZH(gt2,2))
res = res+(Lam5*vd*dZH(gt3,2)*ZA(gt1,1)*ZH(gt2,2))/2._dp
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZH(gt3,2)*ZA(gt1,1)*ZH(gt2,2))
res = res-1._dp/2._dp*(Lam5*vd*dZH(gt3,1)*ZA(gt1,2)*ZH(gt2,2))
res = res+(vd*Conjg(Lam5)*dZH(gt3,1)*ZA(gt1,2)*ZH(gt2,2))/2._dp
res = res+(Lam5*vu*dZH(gt2,2)*ZA(gt1,1)*ZH(gt3,1))/2._dp
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZH(gt2,2)*ZA(gt1,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(Lam5*vu*dZH(gt2,1)*ZA(gt1,2)*ZH(gt3,1))
res = res+(vu*Conjg(Lam5)*dZH(gt2,1)*ZA(gt1,2)*ZH(gt3,1))/2._dp
res = res-1._dp/2._dp*(Lam5*vd*dZH(gt2,2)*ZA(gt1,2)*ZH(gt3,1))
res = res+(vd*Conjg(Lam5)*dZH(gt2,2)*ZA(gt1,2)*ZH(gt3,1))/2._dp
res = res-1._dp/2._dp*(Lam5*vu*dZA(gt1,2)*ZH(gt2,1)*ZH(gt3,1))
res = res+(vu*Conjg(Lam5)*dZA(gt1,2)*ZH(gt2,1)*ZH(gt3,1))/2._dp
res = res-1._dp/2._dp*(dvu*Lam5*ZA(gt1,2)*ZH(gt2,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(dLam5*vu*ZA(gt1,2)*ZH(gt2,1)*ZH(gt3,1))
...
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZA(gt1,1)*ZH(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(Lam5*vd*dZA(gt1,2)*ZH(gt2,2)*ZH(gt3,1))
...
res = res-1._dp/2._dp*(vu*Conjg(dLam5)*ZA(gt1,1)*ZH(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(dvu*Conjg(Lam5)*ZA(gt1,1)*ZH(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(dvd*Lam5*ZA(gt1,2)*ZH(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(dLam5*vd*ZA(gt1,2)*ZH(gt2,2)*ZH(gt3,1))
...
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZH(gt2,1)*ZA(gt1,1)*ZH(gt3,2))
res = res+(Lam5*vd*dZH(gt2,2)*ZA(gt1,1)*ZH(gt3,2))/2._dp
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZH(gt2,2)*ZA(gt1,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(Lam5*vd*dZH(gt2,1)*ZA(gt1,2)*ZH(gt3,2))
res = res+(vd*Conjg(Lam5)*dZH(gt2,1)*ZA(gt1,2)*ZH(gt3,2))/2._dp
res = res+(Lam5*vu*dZA(gt1,1)*ZH(gt2,1)*ZH(gt3,2))/2._dp
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZA(gt1,1)*ZH(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(Lam5*vd*dZA(gt1,2)*ZH(gt2,1)*ZH(gt3,2))
...
res = res-1._dp/2._dp*(vu*Conjg(dLam5)*ZA(gt1,1)*ZH(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(dvu*Conjg(Lam5)*ZA(gt1,1)*ZH(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(dvd*Lam5*ZA(gt1,2)*ZH(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(dLam5*vd*ZA(gt1,2)*ZH(gt2,1)*ZH(gt3,2))
...
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZA(gt1,1)*ZH(gt2,2)*ZH(gt3,2))
res = res+(dvd*Lam5*ZA(gt1,1)*ZH(gt2,2)*ZH(gt3,2))/2._dp
res = res+(dLam5*vd*ZA(gt1,1)*ZH(gt2,2)*ZH(gt3,2))/2._dp
res = res-1._dp/2._dp*(vd*Conjg(dLam5)*ZA(gt1,1)*ZH(gt2,2)*ZH(gt3,2))
res = res-1._dp/2._dp*(dvd*Conjg(Lam5)*ZA(gt1,1)*ZH(gt2,2)*ZH(gt3,2))
res = -(0.,1.)*res 
...
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZP(gt3,2)*ZA(gt1,1)*ZP(gt2,1))
res = res-1._dp/2._dp*(Lam4*vd*dZP(gt3,2)*ZA(gt1,2)*ZP(gt2,1))
res = res+(vd*Conjg(Lam5)*dZP(gt3,2)*ZA(gt1,2)*ZP(gt2,1))/2._dp
res = res-1._dp/2._dp*(Lam4*vu*dZP(gt3,1)*ZA(gt1,1)*ZP(gt2,2))
res = res+(Lam5*vu*dZP(gt3,1)*ZA(gt1,1)*ZP(gt2,2))/2._dp
res = res+(Lam4*vd*dZP(gt3,1)*ZA(gt1,2)*ZP(gt2,2))/2._dp
res = res-1._dp/2._dp*(Lam5*vd*dZP(gt3,1)*ZA(gt1,2)*ZP(gt2,2))
res = res-1._dp/2._dp*(Lam4*vu*dZP(gt2,2)*ZA(gt1,1)*ZP(gt3,1))
res = res+(Lam5*vu*dZP(gt2,2)*ZA(gt1,1)*ZP(gt3,1))/2._dp
res = res+(Lam4*vd*dZP(gt2,2)*ZA(gt1,2)*ZP(gt3,1))/2._dp
res = res-1._dp/2._dp*(Lam5*vd*dZP(gt2,2)*ZA(gt1,2)*ZP(gt3,1))
res = res-1._dp/2._dp*(Lam4*vu*dZA(gt1,1)*ZP(gt2,2)*ZP(gt3,1))
res = res+(Lam5*vu*dZA(gt1,1)*ZP(gt2,2)*ZP(gt3,1))/2._dp
res = res+(Lam4*vd*dZA(gt1,2)*ZP(gt2,2)*ZP(gt3,1))/2._dp
res = res-1._dp/2._dp*(Lam5*vd*dZA(gt1,2)*ZP(gt2,2)*ZP(gt3,1))
res = res-1._dp/2._dp*(dvu*Lam4*ZA(gt1,1)*ZP(gt2,2)*ZP(gt3,1))
res = res+(dvu*Lam5*ZA(gt1,1)*ZP(gt2,2)*ZP(gt3,1))/2._dp
res = res-1._dp/2._dp*(dLam4*vu*ZA(gt1,1)*ZP(gt2,2)*ZP(gt3,1))
res = res+(dLam5*vu*ZA(gt1,1)*ZP(gt2,2)*ZP(gt3,1))/2._dp
res = res+(dvd*Lam4*ZA(gt1,2)*ZP(gt2,2)*ZP(gt3,1))/2._dp
res = res-1._dp/2._dp*(dvd*Lam5*ZA(gt1,2)*ZP(gt2,2)*ZP(gt3,1))
res = res+(dLam4*vd*ZA(gt1,2)*ZP(gt2,2)*ZP(gt3,1))/2._dp
res = res-1._dp/2._dp*(dLam5*vd*ZA(gt1,2)*ZP(gt2,2)*ZP(gt3,1))
res = res+(Lam4*vu*dZP(gt2,1)*ZA(gt1,1)*ZP(gt3,2))/2._dp
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZP(gt2,1)*ZA(gt1,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(Lam4*vd*dZP(gt2,1)*ZA(gt1,2)*ZP(gt3,2))
res = res+(vd*Conjg(Lam5)*dZP(gt2,1)*ZA(gt1,2)*ZP(gt3,2))/2._dp
res = res+(Lam4*vu*dZA(gt1,1)*ZP(gt2,1)*ZP(gt3,2))/2._dp
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZA(gt1,1)*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(Lam4*vd*dZA(gt1,2)*ZP(gt2,1)*ZP(gt3,2))
...
res = res-1._dp/2._dp*(vu*Conjg(dLam5)*ZA(gt1,1)*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(dvu*Conjg(Lam5)*ZA(gt1,1)*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(dvd*Lam4*ZA(gt1,2)*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(dLam4*vd*ZA(gt1,2)*ZP(gt2,1)*ZP(gt3,2))
...
res = 0._dp 
res = res-6*Lam1*vd*dZH(gt3,1)*ZH(gt1,1)*ZH(gt2,1)
res = res-(Lam3*vu*dZH(gt3,2)*ZH(gt1,1)*ZH(gt2,1))
res = res-(Lam4*vu*dZH(gt3,2)*ZH(gt1,1)*ZH(gt2,1))
res = res-1._dp/2._dp*(Lam5*vu*dZH(gt3,2)*ZH(gt1,1)*ZH(gt2,1))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZH(gt3,2)*ZH(gt1,1)*ZH(gt2,1))
res = res-(Lam3*vu*dZH(gt3,1)*ZH(gt1,2)*ZH(gt2,1))
res = res-(Lam4*vu*dZH(gt3,1)*ZH(gt1,2)*ZH(gt2,1))
res = res-1._dp/2._dp*(Lam5*vu*dZH(gt3,1)*ZH(gt1,2)*ZH(gt2,1))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZH(gt3,1)*ZH(gt1,2)*ZH(gt2,1))
res = res-(Lam3*vd*dZH(gt3,2)*ZH(gt1,2)*ZH(gt2,1))
res = res-(Lam4*vd*dZH(gt3,2)*ZH(gt1,2)*ZH(gt2,1))
res = res-1._dp/2._dp*(Lam5*vd*dZH(gt3,2)*ZH(gt1,2)*ZH(gt2,1))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZH(gt3,2)*ZH(gt1,2)*ZH(gt2,1))
res = res-(Lam3*vu*dZH(gt3,1)*ZH(gt1,1)*ZH(gt2,2))
res = res-(Lam4*vu*dZH(gt3,1)*ZH(gt1,1)*ZH(gt2,2))
res = res-1._dp/2._dp*(Lam5*vu*dZH(gt3,1)*ZH(gt1,1)*ZH(gt2,2))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZH(gt3,1)*ZH(gt1,1)*ZH(gt2,2))
res = res-(Lam3*vd*dZH(gt3,2)*ZH(gt1,1)*ZH(gt2,2))
res = res-(Lam4*vd*dZH(gt3,2)*ZH(gt1,1)*ZH(gt2,2))
res = res-1._dp/2._dp*(Lam5*vd*dZH(gt3,2)*ZH(gt1,1)*ZH(gt2,2))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZH(gt3,2)*ZH(gt1,1)*ZH(gt2,2))
res = res-(Lam3*vd*dZH(gt3,1)*ZH(gt1,2)*ZH(gt2,2))
res = res-(Lam4*vd*dZH(gt3,1)*ZH(gt1,2)*ZH(gt2,2))
res = res-1._dp/2._dp*(Lam5*vd*dZH(gt3,1)*ZH(gt1,2)*ZH(gt2,2))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZH(gt3,1)*ZH(gt1,2)*ZH(gt2,2))
res = res-6*Lam2*vu*dZH(gt3,2)*ZH(gt1,2)*ZH(gt2,2)
res = res-6*Lam1*vd*dZH(gt2,1)*ZH(gt1,1)*ZH(gt3,1)
res = res-(Lam3*vu*dZH(gt2,2)*ZH(gt1,1)*ZH(gt3,1))
res = res-(Lam4*vu*dZH(gt2,2)*ZH(gt1,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(Lam5*vu*dZH(gt2,2)*ZH(gt1,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZH(gt2,2)*ZH(gt1,1)*ZH(gt3,1))
res = res-(Lam3*vu*dZH(gt2,1)*ZH(gt1,2)*ZH(gt3,1))
res = res-(Lam4*vu*dZH(gt2,1)*ZH(gt1,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(Lam5*vu*dZH(gt2,1)*ZH(gt1,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZH(gt2,1)*ZH(gt1,2)*ZH(gt3,1))
res = res-(Lam3*vd*dZH(gt2,2)*ZH(gt1,2)*ZH(gt3,1))
res = res-(Lam4*vd*dZH(gt2,2)*ZH(gt1,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(Lam5*vd*dZH(gt2,2)*ZH(gt1,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZH(gt2,2)*ZH(gt1,2)*ZH(gt3,1))
res = res-6*Lam1*vd*dZH(gt1,1)*ZH(gt2,1)*ZH(gt3,1)
res = res-(Lam3*vu*dZH(gt1,2)*ZH(gt2,1)*ZH(gt3,1))
res = res-(Lam4*vu*dZH(gt1,2)*ZH(gt2,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(Lam5*vu*dZH(gt1,2)*ZH(gt2,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZH(gt1,2)*ZH(gt2,1)*ZH(gt3,1))
res = res-6*dvd*Lam1*ZH(gt1,1)*ZH(gt2,1)*ZH(gt3,1)
res = res-6*dLam1*vd*ZH(gt1,1)*ZH(gt2,1)*ZH(gt3,1)
res = res-(dvu*Lam3*ZH(gt1,2)*ZH(gt2,1)*ZH(gt3,1))
res = res-(dvu*Lam4*ZH(gt1,2)*ZH(gt2,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(dvu*Lam5*ZH(gt1,2)*ZH(gt2,1)*ZH(gt3,1))
res = res-(dLam3*vu*ZH(gt1,2)*ZH(gt2,1)*ZH(gt3,1))
res = res-(dLam4*vu*ZH(gt1,2)*ZH(gt2,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(dLam5*vu*ZH(gt1,2)*ZH(gt2,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(vu*Conjg(dLam5)*ZH(gt1,2)*ZH(gt2,1)*ZH(gt3,1))
res = res-1._dp/2._dp*(dvu*Conjg(Lam5)*ZH(gt1,2)*ZH(gt2,1)*ZH(gt3,1))
res = res-(Lam3*vu*dZH(gt1,1)*ZH(gt2,2)*ZH(gt3,1))
res = res-(Lam4*vu*dZH(gt1,1)*ZH(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(Lam5*vu*dZH(gt1,1)*ZH(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZH(gt1,1)*ZH(gt2,2)*ZH(gt3,1))
res = res-(Lam3*vd*dZH(gt1,2)*ZH(gt2,2)*ZH(gt3,1))
res = res-(Lam4*vd*dZH(gt1,2)*ZH(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(Lam5*vd*dZH(gt1,2)*ZH(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZH(gt1,2)*ZH(gt2,2)*ZH(gt3,1))
res = res-(dvu*Lam3*ZH(gt1,1)*ZH(gt2,2)*ZH(gt3,1))
res = res-(dvu*Lam4*ZH(gt1,1)*ZH(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(dvu*Lam5*ZH(gt1,1)*ZH(gt2,2)*ZH(gt3,1))
res = res-(dLam3*vu*ZH(gt1,1)*ZH(gt2,2)*ZH(gt3,1))
res = res-(dLam4*vu*ZH(gt1,1)*ZH(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(dLam5*vu*ZH(gt1,1)*ZH(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(vu*Conjg(dLam5)*ZH(gt1,1)*ZH(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(dvu*Conjg(Lam5)*ZH(gt1,1)*ZH(gt2,2)*ZH(gt3,1))
res = res-(dvd*Lam3*ZH(gt1,2)*ZH(gt2,2)*ZH(gt3,1))
res = res-(dvd*Lam4*ZH(gt1,2)*ZH(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(dvd*Lam5*ZH(gt1,2)*ZH(gt2,2)*ZH(gt3,1))
res = res-(dLam3*vd*ZH(gt1,2)*ZH(gt2,2)*ZH(gt3,1))
res = res-(dLam4*vd*ZH(gt1,2)*ZH(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(dLam5*vd*ZH(gt1,2)*ZH(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(vd*Conjg(dLam5)*ZH(gt1,2)*ZH(gt2,2)*ZH(gt3,1))
res = res-1._dp/2._dp*(dvd*Conjg(Lam5)*ZH(gt1,2)*ZH(gt2,2)*ZH(gt3,1))
res = res-(Lam3*vu*dZH(gt2,1)*ZH(gt1,1)*ZH(gt3,2))
res = res-(Lam4*vu*dZH(gt2,1)*ZH(gt1,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(Lam5*vu*dZH(gt2,1)*ZH(gt1,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZH(gt2,1)*ZH(gt1,1)*ZH(gt3,2))
res = res-(Lam3*vd*dZH(gt2,2)*ZH(gt1,1)*ZH(gt3,2))
res = res-(Lam4*vd*dZH(gt2,2)*ZH(gt1,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(Lam5*vd*dZH(gt2,2)*ZH(gt1,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZH(gt2,2)*ZH(gt1,1)*ZH(gt3,2))
res = res-(Lam3*vd*dZH(gt2,1)*ZH(gt1,2)*ZH(gt3,2))
res = res-(Lam4*vd*dZH(gt2,1)*ZH(gt1,2)*ZH(gt3,2))
res = res-1._dp/2._dp*(Lam5*vd*dZH(gt2,1)*ZH(gt1,2)*ZH(gt3,2))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZH(gt2,1)*ZH(gt1,2)*ZH(gt3,2))
res = res-6*Lam2*vu*dZH(gt2,2)*ZH(gt1,2)*ZH(gt3,2)
res = res-(Lam3*vu*dZH(gt1,1)*ZH(gt2,1)*ZH(gt3,2))
res = res-(Lam4*vu*dZH(gt1,1)*ZH(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(Lam5*vu*dZH(gt1,1)*ZH(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZH(gt1,1)*ZH(gt2,1)*ZH(gt3,2))
res = res-(Lam3*vd*dZH(gt1,2)*ZH(gt2,1)*ZH(gt3,2))
res = res-(Lam4*vd*dZH(gt1,2)*ZH(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(Lam5*vd*dZH(gt1,2)*ZH(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZH(gt1,2)*ZH(gt2,1)*ZH(gt3,2))
res = res-(dvu*Lam3*ZH(gt1,1)*ZH(gt2,1)*ZH(gt3,2))
res = res-(dvu*Lam4*ZH(gt1,1)*ZH(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(dvu*Lam5*ZH(gt1,1)*ZH(gt2,1)*ZH(gt3,2))
res = res-(dLam3*vu*ZH(gt1,1)*ZH(gt2,1)*ZH(gt3,2))
res = res-(dLam4*vu*ZH(gt1,1)*ZH(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(dLam5*vu*ZH(gt1,1)*ZH(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(vu*Conjg(dLam5)*ZH(gt1,1)*ZH(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(dvu*Conjg(Lam5)*ZH(gt1,1)*ZH(gt2,1)*ZH(gt3,2))
res = res-(dvd*Lam3*ZH(gt1,2)*ZH(gt2,1)*ZH(gt3,2))
res = res-(dvd*Lam4*ZH(gt1,2)*ZH(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(dvd*Lam5*ZH(gt1,2)*ZH(gt2,1)*ZH(gt3,2))
res = res-(dLam3*vd*ZH(gt1,2)*ZH(gt2,1)*ZH(gt3,2))
res = res-(dLam4*vd*ZH(gt1,2)*ZH(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(dLam5*vd*ZH(gt1,2)*ZH(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(vd*Conjg(dLam5)*ZH(gt1,2)*ZH(gt2,1)*ZH(gt3,2))
res = res-1._dp/2._dp*(dvd*Conjg(Lam5)*ZH(gt1,2)*ZH(gt2,1)*ZH(gt3,2))
res = res-(Lam3*vd*dZH(gt1,1)*ZH(gt2,2)*ZH(gt3,2))
res = res-(Lam4*vd*dZH(gt1,1)*ZH(gt2,2)*ZH(gt3,2))
res = res-1._dp/2._dp*(Lam5*vd*dZH(gt1,1)*ZH(gt2,2)*ZH(gt3,2))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZH(gt1,1)*ZH(gt2,2)*ZH(gt3,2))
res = res-6*Lam2*vu*dZH(gt1,2)*ZH(gt2,2)*ZH(gt3,2)
res = res-(dvd*Lam3*ZH(gt1,1)*ZH(gt2,2)*ZH(gt3,2))
res = res-(dvd*Lam4*ZH(gt1,1)*ZH(gt2,2)*ZH(gt3,2))
res = res-1._dp/2._dp*(dvd*Lam5*ZH(gt1,1)*ZH(gt2,2)*ZH(gt3,2))
res = res-(dLam3*vd*ZH(gt1,1)*ZH(gt2,2)*ZH(gt3,2))
res = res-(dLam4*vd*ZH(gt1,1)*ZH(gt2,2)*ZH(gt3,2))
res = res-1._dp/2._dp*(dLam5*vd*ZH(gt1,1)*ZH(gt2,2)*ZH(gt3,2))
res = res-1._dp/2._dp*(vd*Conjg(dLam5)*ZH(gt1,1)*ZH(gt2,2)*ZH(gt3,2))
res = res-1._dp/2._dp*(dvd*Conjg(Lam5)*ZH(gt1,1)*ZH(gt2,2)*ZH(gt3,2))
res = res-6*dvu*Lam2*ZH(gt1,2)*ZH(gt2,2)*ZH(gt3,2)
res = res-6*dLam2*vu*ZH(gt1,2)*ZH(gt2,2)*ZH(gt3,2)
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = 0._dp 
res = res-2*Lam1*vd*dZP(gt3,1)*ZH(gt1,1)*ZP(gt2,1)
res = res-1._dp/2._dp*(Lam4*vu*dZP(gt3,2)*ZH(gt1,1)*ZP(gt2,1))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZP(gt3,2)*ZH(gt1,1)*ZP(gt2,1))
res = res-(Lam3*vu*dZP(gt3,1)*ZH(gt1,2)*ZP(gt2,1))
res = res-1._dp/2._dp*(Lam4*vd*dZP(gt3,2)*ZH(gt1,2)*ZP(gt2,1))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZP(gt3,2)*ZH(gt1,2)*ZP(gt2,1))
res = res-1._dp/2._dp*(Lam4*vu*dZP(gt3,1)*ZH(gt1,1)*ZP(gt2,2))
res = res-1._dp/2._dp*(Lam5*vu*dZP(gt3,1)*ZH(gt1,1)*ZP(gt2,2))
res = res-(Lam3*vd*dZP(gt3,2)*ZH(gt1,1)*ZP(gt2,2))
res = res-1._dp/2._dp*(Lam4*vd*dZP(gt3,1)*ZH(gt1,2)*ZP(gt2,2))
res = res-1._dp/2._dp*(Lam5*vd*dZP(gt3,1)*ZH(gt1,2)*ZP(gt2,2))
res = res-2*Lam2*vu*dZP(gt3,2)*ZH(gt1,2)*ZP(gt2,2)
res = res-2*Lam1*vd*dZP(gt2,1)*ZH(gt1,1)*ZP(gt3,1)
res = res-1._dp/2._dp*(Lam4*vu*dZP(gt2,2)*ZH(gt1,1)*ZP(gt3,1))
res = res-1._dp/2._dp*(Lam5*vu*dZP(gt2,2)*ZH(gt1,1)*ZP(gt3,1))
res = res-(Lam3*vu*dZP(gt2,1)*ZH(gt1,2)*ZP(gt3,1))
res = res-1._dp/2._dp*(Lam4*vd*dZP(gt2,2)*ZH(gt1,2)*ZP(gt3,1))
res = res-1._dp/2._dp*(Lam5*vd*dZP(gt2,2)*ZH(gt1,2)*ZP(gt3,1))
res = res-2*Lam1*vd*dZH(gt1,1)*ZP(gt2,1)*ZP(gt3,1)
res = res-(Lam3*vu*dZH(gt1,2)*ZP(gt2,1)*ZP(gt3,1))
res = res-2*dvd*Lam1*ZH(gt1,1)*ZP(gt2,1)*ZP(gt3,1)
res = res-2*dLam1*vd*ZH(gt1,1)*ZP(gt2,1)*ZP(gt3,1)
...
res = res-1._dp/2._dp*(Lam5*vu*dZH(gt1,1)*ZP(gt2,2)*ZP(gt3,1))
res = res-1._dp/2._dp*(Lam4*vd*dZH(gt1,2)*ZP(gt2,2)*ZP(gt3,1))
res = res-1._dp/2._dp*(Lam5*vd*dZH(gt1,2)*ZP(gt2,2)*ZP(gt3,1))
res = res-1._dp/2._dp*(dvu*Lam4*ZH(gt1,1)*ZP(gt2,2)*ZP(gt3,1))
res = res-1._dp/2._dp*(dvu*Lam5*ZH(gt1,1)*ZP(gt2,2)*ZP(gt3,1))
res = res-1._dp/2._dp*(dLam4*vu*ZH(gt1,1)*ZP(gt2,2)*ZP(gt3,1))
res = res-1._dp/2._dp*(dLam5*vu*ZH(gt1,1)*ZP(gt2,2)*ZP(gt3,1))
res = res-1._dp/2._dp*(dvd*Lam4*ZH(gt1,2)*ZP(gt2,2)*ZP(gt3,1))
res = res-1._dp/2._dp*(dvd*Lam5*ZH(gt1,2)*ZP(gt2,2)*ZP(gt3,1))
res = res-1._dp/2._dp*(dLam4*vd*ZH(gt1,2)*ZP(gt2,2)*ZP(gt3,1))
res = res-1._dp/2._dp*(dLam5*vd*ZH(gt1,2)*ZP(gt2,2)*ZP(gt3,1))
res = res-1._dp/2._dp*(Lam4*vu*dZP(gt2,1)*ZH(gt1,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZP(gt2,1)*ZH(gt1,1)*ZP(gt3,2))
res = res-(Lam3*vd*dZP(gt2,2)*ZH(gt1,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(Lam4*vd*dZP(gt2,1)*ZH(gt1,2)*ZP(gt3,2))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZP(gt2,1)*ZH(gt1,2)*ZP(gt3,2))
res = res-2*Lam2*vu*dZP(gt2,2)*ZH(gt1,2)*ZP(gt3,2)
res = res-1._dp/2._dp*(Lam4*vu*dZH(gt1,1)*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(vu*Conjg(Lam5)*dZH(gt1,1)*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(Lam4*vd*dZH(gt1,2)*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(vd*Conjg(Lam5)*dZH(gt1,2)*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(dvu*Lam4*ZH(gt1,1)*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(dLam4*vu*ZH(gt1,1)*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(vu*Conjg(dLam5)*ZH(gt1,1)*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(dvu*Conjg(Lam5)*ZH(gt1,1)*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(dvd*Lam4*ZH(gt1,2)*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(dLam4*vd*ZH(gt1,2)*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(vd*Conjg(dLam5)*ZH(gt1,2)*ZP(gt2,1)*ZP(gt3,2))
res = res-1._dp/2._dp*(dvd*Conjg(Lam5)*ZH(gt1,2)*ZP(gt2,1)*ZP(gt3,2))
res = res-(Lam3*vd*dZH(gt1,1)*ZP(gt2,2)*ZP(gt3,2))
res = res-2*Lam2*vu*dZH(gt1,2)*ZP(gt2,2)*ZP(gt3,2)
res = res-(dvd*Lam3*ZH(gt1,1)*ZP(gt2,2)*ZP(gt3,2))
res = res-(dLam3*vd*ZH(gt1,1)*ZP(gt2,2)*ZP(gt3,2))
res = res-2*dvu*Lam2*ZH(gt1,2)*ZP(gt2,2)*ZP(gt3,2)
res = res-2*dLam2*vu*ZH(gt1,2)*ZP(gt2,2)*ZP(gt3,2)
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = 0._dp 
res = res-1._dp/2._dp*(g2*dZP(gt2,1)*ZA(gt1,1))
res = res-1._dp/2._dp*(g2*dZP(gt2,2)*ZA(gt1,2))
res = res-1._dp/2._dp*(g2*dZA(gt1,1)*ZP(gt2,1))
res = res-1._dp/2._dp*(dg2*ZA(gt1,1)*ZP(gt2,1))
res = res-1._dp/2._dp*(g2*dZA(gt1,2)*ZP(gt2,2))
res = res-1._dp/2._dp*(dg2*ZA(gt1,2)*ZP(gt2,2))
res = -(0.,1.)*res 
