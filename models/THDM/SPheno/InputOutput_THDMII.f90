...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - THDM-II-v2 Spectrum + Decays + Flavour Observables"
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.THDMII",status="unknown")
...
Subroutine WriteWCXF 
   Open(123,file="WC.THDMII_1.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
...
Write(123,*) "}"
    Close(123) 
   Open(123,file="WC.THDMII_2.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
Write(123,*) '  "basis": "FlavorKit",'
Write(123,*) '  "scale": "91.",'
