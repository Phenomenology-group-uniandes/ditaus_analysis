...
Subroutine Amplitude_Tree_THDMII_FuToFuAh(cplcFuFuAhL,cplcFuFuAhR,MAh,MFu,            & 
& MAh2,MFu2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_THDMII_FuToFuAh


Subroutine Gamma_Real_THDMII_FuToFuAh(MLambda,em,gs,cplcFuFuAhL,cplcFuFuAhR,          & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_THDMII_FuToFuAh


Subroutine Amplitude_WAVE_THDMII_FuToFuAh(cplcFuFuAhL,cplcFuFuAhR,ctcplcFuFuAhL,      & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMII_FuToFuAh


Subroutine Amplitude_VERTEX_THDMII_FuToFuAh(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,              & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMII_FuToFuAh


Subroutine Amplitude_IR_VERTEX_THDMII_FuToFuAh(MAh,MFd,MFu,Mhh,MHm,MVG,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMII_FuToFuAh


Subroutine Amplitude_Tree_THDMII_FuToFdcHm(cplcFuFdcHmL,cplcFuFdcHmR,MFd,             & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_THDMII_FuToFdcHm


Subroutine Gamma_Real_THDMII_FuToFdcHm(MLambda,em,gs,cplcFuFdcHmL,cplcFuFdcHmR,       & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_THDMII_FuToFdcHm


Subroutine Amplitude_WAVE_THDMII_FuToFdcHm(cplcFuFdcHmL,cplcFuFdcHmR,ctcplcFuFdcHmL,  & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMII_FuToFdcHm


Subroutine Amplitude_VERTEX_THDMII_FuToFdcHm(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,             & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMII_FuToFdcHm


Subroutine Amplitude_IR_VERTEX_THDMII_FuToFdcHm(MAh,MFd,MFu,Mhh,MHm,MVG,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMII_FuToFdcHm


Subroutine Amplitude_Tree_THDMII_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,              & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_THDMII_FuToFdcVWm


Subroutine Gamma_Real_THDMII_FuToFdcVWm(MLambda,em,gs,cplcFuFdcVWmL,cplcFuFdcVWmR,    & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_THDMII_FuToFdcVWm


Subroutine Amplitude_WAVE_THDMII_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,              & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMII_FuToFdcVWm


Subroutine Amplitude_VERTEX_THDMII_FuToFdcVWm(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,            & 
& MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,        & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMII_FuToFdcVWm


Subroutine Amplitude_IR_VERTEX_THDMII_FuToFdcVWm(MAh,MFd,MFu,Mhh,MHm,MVG,             & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,    & 
& cplcFuFuAhL,cplcFuFuAhR,cplAhHmcVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,               & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,          & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMII_FuToFdcVWm


Subroutine Amplitude_Tree_THDMII_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,            & 
& MFu2,Mhh2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_THDMII_FuToFuhh


Subroutine Gamma_Real_THDMII_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,          & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_THDMII_FuToFuhh


Subroutine Amplitude_WAVE_THDMII_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,      & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMII_FuToFuhh


Subroutine Amplitude_VERTEX_THDMII_FuToFuhh(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,              & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMII_FuToFuhh


Subroutine Amplitude_IR_VERTEX_THDMII_FuToFuhh(MAh,MFd,MFu,Mhh,MHm,MVG,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMII_FuToFuhh


Subroutine Amplitude_Tree_THDMII_FuToFuVZ(cplcFuFuVZL,cplcFuFuVZR,MFu,MVZ,            & 
& MFu2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_THDMII_FuToFuVZ


Subroutine Gamma_Real_THDMII_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,          & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_THDMII_FuToFuVZ


Subroutine Amplitude_WAVE_THDMII_FuToFuVZ(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,        & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMII_FuToFuVZ


Subroutine Amplitude_VERTEX_THDMII_FuToFuVZ(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,              & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMII_FuToFuVZ


Subroutine Amplitude_IR_VERTEX_THDMII_FuToFuVZ(MAh,MFd,MFu,Mhh,MHm,MVG,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMII_FuToFuVZ


Subroutine Amplitude_WAVE_THDMII_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,ctcplcFuFuVGL,      & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMII_FuToFuVG


Subroutine Amplitude_VERTEX_THDMII_FuToFuVG(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,              & 
& MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,        & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMII_FuToFuVG


Subroutine Amplitude_IR_VERTEX_THDMII_FuToFuVG(MAh,MFd,MFu,Mhh,MHm,MVG,               & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,    & 
& cplcFdFdVGL,cplcFdFdVGR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,         & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,               & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMII_FuToFuVG


Subroutine Amplitude_WAVE_THDMII_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,        & 
& cplcFuFuVZR,ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,ctcplcFuFuVZR,MFu,               & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_THDMII_FuToFuVP


Subroutine Amplitude_VERTEX_THDMII_FuToFuVP(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,              & 
& MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,        & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_THDMII_FuToFuVP


Subroutine Amplitude_IR_VERTEX_THDMII_FuToFuVP(MAh,MFd,MFu,Mhh,MHm,MVG,               & 
& MVP,MVWm,MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,    & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,         & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,               & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_THDMII_FuToFuVP



End Module OneLoopDecay_Fu_THDMII
