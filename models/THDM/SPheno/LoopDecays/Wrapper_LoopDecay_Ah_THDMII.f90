...
Module Wrapper_OneLoopDecay_Ah_THDMII
Use Model_Data_THDMII 
Use Kinematics 
Use OneLoopDecay_Ah_THDMII 
Use Control 
Use Settings 
...
Call Amplitude_Tree_THDMII_AhToAhAh(cplAhAhAh,MAh,MAh2,AmpTreeAhToAhAh)

  Else 
Call Amplitude_Tree_THDMII_AhToAhAh(ZcplAhAhAh,MAh,MAh2,AmpTreeAhToAhAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_AhToAhAh(MLambda,em,gs,cplAhAhAh,MAhOS,MRPAhToAhAh,            & 
& MRGAhToAhAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_AhToAhAh(MLambda,em,gs,ZcplAhAhAh,MAhOS,MRPAhToAhAh,           & 
& MRGAhToAhAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_AhToAhAh(MLambda,em,gs,cplAhAhAh,MAh,MRPAhToAhAh,              & 
& MRGAhToAhAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_AhToAhAh(MLambda,em,gs,ZcplAhAhAh,MAh,MRPAhToAhAh,             & 
& MRGAhToAhAh)
...
Call Amplitude_WAVE_THDMII_AhToAhAh(cplAhAhAh,ctcplAhAhAh,MAh,MAh2,ZfAh,              & 
& AmpWaveAhToAhAh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhToAhAh(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_AhToAhAh(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,            & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,              & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplAhAhAhAh1,    & 
& cplAhAhAhhh1,cplAhAhhhhh1,cplAhAhHmcHm1,AmpVertexIRdrAhToAhAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_AhToAhAh(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,               & 
...
& cplAhcHmVWm,cplAhAhAhAh1,cplAhAhAhhh1,cplAhAhhhhh1,cplAhAhHmcHm1,AmpVertexIRosAhToAhAh)
 ...
 ! DR and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_AhToAhAh(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,            & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,ZcplAhAhAh,cplAhAhhh,cplcFdFdAhL,             & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplAhAhAhAh1,    & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_AhTohhAh(cplAhAhhh,MAh,Mhh,MAh2,Mhh2,AmpTreeAhTohhAh)

  Else 
Call Amplitude_Tree_THDMII_AhTohhAh(ZcplAhAhhh,MAh,Mhh,MAh2,Mhh2,AmpTreeAhTohhAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_AhTohhAh(MLambda,em,gs,cplAhAhhh,MAhOS,MhhOS,MRPAhTohhAh,      & 
& MRGAhTohhAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_AhTohhAh(MLambda,em,gs,ZcplAhAhhh,MAhOS,MhhOS,MRPAhTohhAh,     & 
& MRGAhTohhAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_AhTohhAh(MLambda,em,gs,cplAhAhhh,MAh,Mhh,MRPAhTohhAh,          & 
& MRGAhTohhAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_AhTohhAh(MLambda,em,gs,ZcplAhAhhh,MAh,Mhh,MRPAhTohhAh,         & 
& MRGAhTohhAh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_AhTohhAh(cplAhAhhh,ctcplAhAhhh,MAh,MAh2,Mhh,               & 
& Mhh2,ZfAh,Zfhh,AmpWaveAhTohhAh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhTohhAh(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,               & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,              & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_AhTohhAh(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,            & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,              & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWmgWmhh,              & 
...
& cplAhAhVZVZ1,cplAhhhhhhh1,cplAhhhHmcHm1,AmpVertexIRdrAhTohhAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_AhTohhAh(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,               & 
& MHmOS,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVWm2OS,MVZ2OS,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_AhTocFdFd(cplcFdFdAhL,cplcFdFdAhR,MAh,MFd,MAh2,            & 
& MFd2,AmpTreeAhTocFdFd)

  Else 
Call Amplitude_Tree_THDMII_AhTocFdFd(ZcplcFdFdAhL,ZcplcFdFdAhR,MAh,MFd,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_AhTocFdFd(MLambda,em,gs,cplcFdFdAhL,cplcFdFdAhR,               & 
& MAhOS,MFdOS,MRPAhTocFdFd,MRGAhTocFdFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_AhTocFdFd(MLambda,em,gs,ZcplcFdFdAhL,ZcplcFdFdAhR,             & 
& MAhOS,MFdOS,MRPAhTocFdFd,MRGAhTocFdFd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_AhTocFdFd(cplcFdFdAhL,cplcFdFdAhR,ctcplcFdFdAhL,           & 
& ctcplcFdFdAhR,MAh,MAh2,MFd,MFd2,ZfAh,ZfDL,ZfDR,AmpWaveAhTocFdFd)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhTocFdFd(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_AhTocFdFd(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,           & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,        & 
& cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,               & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,           & 
& cplcFuFdcVWmR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,AmpVertexIRdrAhTocFdFd)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_AhTocFdFd(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,              & 
...
& cplcFdFuVWmL,cplcFdFuVWmR,AmpVertexIRosAhTocFdFd)
 ...
 ! DR and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_AhTocFdFd(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,           & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,ZcplcFdFdAhL,    & 
& ZcplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,       & 
& cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,               & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,           & 
& cplcFuFdcVWmR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,AmpVertexIRosAhTocFdFd)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_AhTocFeFe(cplcFeFeAhL,cplcFeFeAhR,MAh,MFe,MAh2,            & 
& MFe2,AmpTreeAhTocFeFe)

  Else 
Call Amplitude_Tree_THDMII_AhTocFeFe(ZcplcFeFeAhL,ZcplcFeFeAhR,MAh,MFe,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_AhTocFeFe(MLambda,em,gs,cplcFeFeAhL,cplcFeFeAhR,               & 
& MAhOS,MFeOS,MRPAhTocFeFe,MRGAhTocFeFe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_AhTocFeFe(MLambda,em,gs,ZcplcFeFeAhL,ZcplcFeFeAhR,             & 
& MAhOS,MFeOS,MRPAhTocFeFe,MRGAhTocFeFe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_AhTocFeFe(cplcFeFeAhL,cplcFeFeAhR,ctcplcFeFeAhL,           & 
& ctcplcFeFeAhR,MAh,MAh2,MFe,MFe2,ZfAh,ZfEL,ZfER,AmpWaveAhTocFeFe)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhTocFeFe(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,MAh2,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_AhTocFeFe(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,               & 
...
& AmpVertexIRdrAhTocFeFe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_AhTocFeFe(MAhOS,MFeOS,MhhOS,MHmOS,MVP,MVWmOS,         & 
& MVZOS,MAh2OS,MFe2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhAh,cplAhAhhh,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_AhTocFuFu(cplcFuFuAhL,cplcFuFuAhR,MAh,MFu,MAh2,            & 
& MFu2,AmpTreeAhTocFuFu)

  Else 
Call Amplitude_Tree_THDMII_AhTocFuFu(ZcplcFuFuAhL,ZcplcFuFuAhR,MAh,MFu,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_AhTocFuFu(MLambda,em,gs,cplcFuFuAhL,cplcFuFuAhR,               & 
& MAhOS,MFuOS,MRPAhTocFuFu,MRGAhTocFuFu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_AhTocFuFu(MLambda,em,gs,ZcplcFuFuAhL,ZcplcFuFuAhR,             & 
& MAhOS,MFuOS,MRPAhTocFuFu,MRGAhTocFuFu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_AhTocFuFu(cplcFuFuAhL,cplcFuFuAhR,ctcplcFuFuAhL,           & 
& ctcplcFuFuAhR,MAh,MAh2,MFu,MFu2,ZfAh,ZfUL,ZfUR,AmpWaveAhTocFuFu)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhTocFuFu(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,              & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,        & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_AhTocFuFu(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,           & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,        & 
& cplAhcHmVWm,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,         & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
& cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,AmpVertexIRdrAhTocFuFu)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_AhTocFuFu(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,              & 
& MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,             & 
...
Call Amplitude_IR_VERTEX_THDMII_AhTocFuFu(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,           & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,     & 
& cplcFdFdAhR,ZcplcFuFuAhL,ZcplcFuFuAhR,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,      & 
& cplAhcHmVWm,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,         & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
& cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,AmpVertexIRosAhTocFuFu)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_AhTohhhh(cplAhhhhh,MAh,Mhh,MAh2,Mhh2,AmpTreeAhTohhhh)

  Else 
Call Amplitude_Tree_THDMII_AhTohhhh(ZcplAhhhhh,MAh,Mhh,MAh2,Mhh2,AmpTreeAhTohhhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_AhTohhhh(MLambda,em,gs,cplAhhhhh,MAhOS,MhhOS,MRPAhTohhhh,      & 
& MRGAhTohhhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_AhTohhhh(MLambda,em,gs,ZcplAhhhhh,MAhOS,MhhOS,MRPAhTohhhh,     & 
& MRGAhTohhhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_AhTohhhh(MLambda,em,gs,cplAhhhhh,MAh,Mhh,MRPAhTohhhh,          & 
& MRGAhTohhhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_AhTohhhh(MLambda,em,gs,ZcplAhhhhh,MAh,Mhh,MRPAhTohhhh,         & 
& MRGAhTohhhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_AhTohhhh(cplAhhhhh,ctcplAhhhhh,MAh,MAh2,Mhh,               & 
& Mhh2,ZfAh,Zfhh,AmpWaveAhTohhhh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhTohhhh(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,               & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,              & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWmgWmhh,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_AhTohhhh(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,            & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,              & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWmgWmhh,              & 
...
& AmpVertexIRdrAhTohhhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_AhTohhhh(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,               & 
& MHmOS,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVWm2OS,MVZ2OS,           & 
& cplAhAhAh,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,       & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_AhTohhVZ(cplAhhhVZ,MAh,Mhh,MVZ,MAh2,Mhh2,MVZ2,             & 
& AmpTreeAhTohhVZ)

  Else 
Call Amplitude_Tree_THDMII_AhTohhVZ(ZcplAhhhVZ,MAh,Mhh,MVZ,MAh2,Mhh2,MVZ2,            & 
& AmpTreeAhTohhVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_AhTohhVZ(MLambda,em,gs,cplAhhhVZ,MAhOS,MhhOS,MVZOS,            & 
& MRPAhTohhVZ,MRGAhTohhVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_AhTohhVZ(MLambda,em,gs,ZcplAhhhVZ,MAhOS,MhhOS,MVZOS,           & 
& MRPAhTohhVZ,MRGAhTohhVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_AhTohhVZ(MLambda,em,gs,cplAhhhVZ,MAh,Mhh,MVZ,MRPAhTohhVZ,      & 
& MRGAhTohhVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_AhTohhVZ(MLambda,em,gs,ZcplAhhhVZ,MAh,Mhh,MVZ,MRPAhTohhVZ,     & 
& MRGAhTohhVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_AhTohhVZ(cplAhhhVZ,ctcplAhhhVZ,MAh,MAh2,Mhh,               & 
& Mhh2,MVZ,MVZ2,ZfAh,Zfhh,ZfVZ,AmpWaveAhTohhVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhTohhVZ(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,               & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,              & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,     & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_AhTohhVZ(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,            & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,              & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,               & 
...
& AmpVertexIRdrAhTohhVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_AhTohhVZ(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,               & 
& MHmOS,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVWm2OS,MVZ2OS,           & 
& cplAhAhAh,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,       & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_AhTocHmHm(cplAhHmcHm,MAh,MHm,MAh2,MHm2,AmpTreeAhTocHmHm)

  Else 
Call Amplitude_Tree_THDMII_AhTocHmHm(ZcplAhHmcHm,MAh,MHm,MAh2,MHm2,AmpTreeAhTocHmHm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_AhTocHmHm(MLambda,em,gs,cplAhHmcHm,MAhOS,MHmOS,MRPAhTocHmHm,   & 
& MRGAhTocHmHm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_AhTocHmHm(MLambda,em,gs,ZcplAhHmcHm,MAhOS,MHmOS,               & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_AhTocHmHm(MLambda,em,gs,cplAhHmcHm,MAh,MHm,MRPAhTocHmHm,       & 
& MRGAhTocHmHm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_AhTocHmHm(MLambda,em,gs,ZcplAhHmcHm,MAh,MHm,MRPAhTocHmHm,      & 
& MRGAhTocHmHm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_AhTocHmHm(cplAhHmcHm,ctcplAhHmcHm,MAh,MAh2,MHm,            & 
& MHm2,ZfAh,ZfHm,AmpWaveAhTocHmHm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhTocHmHm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_AhTocHmHm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,           & 
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFuFdcHmL,    & 
& cplcFuFdcHmR,cplcFvFecHmL,cplcFvFecHmR,cplcFdFuHmL,cplcFdFuHmR,cplcFeFvHmL,            & 
...
& cplhhHmcVWm,cplhhcHmVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplHmcVWmVZ,cplcHmVPVWm,     & 
& cplcHmVWmVZ,cplAhAhHmcHm1,cplAhhhHmcHm1,cplAhHmcVWmVP1,cplAhHmcVWmVZ1,cplAhcHmVPVWm1,  & 
& cplAhcHmVWmVZ1,cplhhhhHmcHm1,cplHmHmcHmcHm1,AmpVertexIRdrAhTocHmHm)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_AhTocHmHm(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,              & 
...
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,ZcplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFuFdcHmL,   & 
& cplcFuFdcHmR,cplcFvFecHmL,cplcFvFecHmR,cplcFdFuHmL,cplcFdFuHmR,cplcFeFvHmL,            & 
& cplcFeFvHmR,cplcgZgWmcHm,cplcgZgWpCHm,cplcgWmgZHm,cplcgWpCgZcHm,cplhhHmcHm,            & 
& cplhhHmcVWm,cplhhcHmVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplHmcVWmVZ,cplcHmVPVWm,     & 
& cplcHmVWmVZ,cplAhAhHmcHm1,cplAhhhHmcHm1,cplAhHmcVWmVP1,cplAhHmcVWmVZ1,cplAhcHmVPVWm1,  & 
& cplAhcHmVWmVZ1,cplhhhhHmcHm1,cplHmHmcHmcHm1,AmpVertexIRosAhTocHmHm)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_AhToHmcVWm(cplAhHmcVWm,MAh,MHm,MVWm,MAh2,MHm2,             & 
& MVWm2,AmpTreeAhToHmcVWm)

  Else 
Call Amplitude_Tree_THDMII_AhToHmcVWm(ZcplAhHmcVWm,MAh,MHm,MVWm,MAh2,MHm2,            & 
& MVWm2,AmpTreeAhToHmcVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_AhToHmcVWm(MLambda,em,gs,cplAhHmcVWm,MAhOS,MHmOS,              & 
& MVWmOS,MRPAhToHmcVWm,MRGAhToHmcVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_AhToHmcVWm(MLambda,em,gs,ZcplAhHmcVWm,MAhOS,MHmOS,             & 
& MVWmOS,MRPAhToHmcVWm,MRGAhToHmcVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_AhToHmcVWm(MLambda,em,gs,cplAhHmcVWm,MAh,MHm,MVWm,             & 
& MRPAhToHmcVWm,MRGAhToHmcVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_AhToHmcVWm(MLambda,em,gs,ZcplAhHmcVWm,MAh,MHm,MVWm,            & 
& MRPAhToHmcVWm,MRGAhToHmcVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_AhToHmcVWm(cplAhHmcVWm,ctcplAhHmcVWm,MAh,MAh2,             & 
& MHm,MHm2,MVWm,MVWm2,ZfAh,ZfHm,ZfVWm,AmpWaveAhToHmcVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhToHmcVWm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,             & 
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_AhToHmcVWm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,               & 
...
& cplAhHmcVWmVP1,cplAhHmcVWmVZ1,cplhhHmcVWmVZ1,cplHmcHmcVWmVWm1,AmpVertexIRdrAhToHmcVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_AhToHmcVWm(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,             & 
& MHmOS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,         & 
& MVZ2OS,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,            & 
& cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_AhToAhVP(MAhOS,MFdOS,MFeOS,MFuOS,MHmOS,MVP,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhToAhVP(MAh,MFd,MFe,MFu,MHm,MVP,MVWm,MAh2,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_AhToAhVZ(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhToAhVZ(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,               & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,              & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_AhToFvcFv(MAhOS,MFeOS,MHmOS,MVWmOS,MAh2OS,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhToFvcFv(MAh,MFe,MHm,MVWm,MAh2,MFe2,MHm2,               & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_THDMII_AhTohhVP(cplAhhhVZ,ctcplAhhhVZ,MAhOS,MAh2OS,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_AhTohhVP(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_AhTohhVP(cplAhhhVZ,ctcplAhhhVZ,MAh,MAh2,Mhh,               & 
& Mhh2,MVP,MVP2,MVZ,MVZ2,ZfAh,Zfhh,ZfVP,ZfVZVP,AmpWaveAhTohhVP)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhTohhVP(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_AhToVGVG(MAhOS,MFdOS,MFuOS,MVG,MAh2OS,MFd2OS,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhToVGVG(MAh,MFd,MFu,MVG,MAh2,MFd2,MFu2,MVG2,            & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplcFdFdVGL,cplcFdFdVGR,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_AhToVPVP(MAhOS,MFdOS,MFeOS,MFuOS,MHmOS,MVP,              & 
& MVWmOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,MHm2OS,MVP2,MVWm2OS,cplcFdFdAhL,cplcFdFdAhR,        & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,           & 
& cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdVPL,cplcFdFdVPR,cplcFeFeVPL,cplcFeFeVPR,    & 
& cplcFuFuVPL,cplcFuFuVPR,cplcgWmgWmVP,cplcgWpCgWpCVP,cplHmcHmVP,cplHmcVWmVP,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhToVPVP(MAh,MFd,MFe,MFu,MHm,MVP,MVWm,MAh2,              & 
& MFd2,MFe2,MFu2,MHm2,MVP2,MVWm2,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,        & 
& cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhHmcHm,cplAhHmcVWm,            & 
& cplAhcHmVWm,cplcFdFdVPL,cplcFdFdVPR,cplcFeFeVPL,cplcFeFeVPR,cplcFuFuVPL,               & 
& cplcFuFuVPR,cplcgWmgWmVP,cplcgWpCgWpCVP,cplHmcHmVP,cplHmcVWmVP,cplcHmVPVWm,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_AhToVPVZ(MAhOS,MFdOS,MFeOS,MFuOS,MHmOS,MVP,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhToVPVZ(MAh,MFd,MFe,MFu,MHm,MVP,MVWm,MVZ,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_AhToVWmcVWm(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,               & 
& MHmOS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,         & 
& MVZ2OS,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,            & 
& cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhToVWmcVWm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,            & 
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFuFdcVWmL,   & 
...
& cplHmcVWmVP,cplHmcVWmVZ,cplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,             & 
& cplAhAhcVWmVWm1,cplAhHmcVWmVP1,cplAhHmcVWmVZ1,cplAhcHmVPVWm1,cplAhcHmVWmVZ1,           & 
& cplhhhhcVWmVWm1,cplHmcHmcVWmVWm1,AmpVertexAhToVWmcVWm)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_AhToVZVZ(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,            & 
& MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVWm2OS,MVZ2OS,cplAhAhAh,       & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,               & 
& cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,    & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_AhToVZVZ(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,               & 
...
End Module Wrapper_OneLoopDecay_Ah_THDMII
