...
Module Wrapper_OneLoopDecay_Fd_THDMII
Use Model_Data_THDMII 
Use Kinematics 
Use OneLoopDecay_Fd_THDMII 
Use Control 
Use Settings 
...
Call Amplitude_Tree_THDMII_FdToFdAh(cplcFdFdAhL,cplcFdFdAhR,MAh,MFd,MAh2,             & 
& MFd2,AmpTreeFdToFdAh)

  Else 
Call Amplitude_Tree_THDMII_FdToFdAh(ZcplcFdFdAhL,ZcplcFdFdAhR,MAh,MFd,MAh2,           & 
& MFd2,AmpTreeFdToFdAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_FdToFdAh(MLambda,em,gs,cplcFdFdAhL,cplcFdFdAhR,MAhOS,          & 
& MFdOS,MRPFdToFdAh,MRGFdToFdAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_FdToFdAh(MLambda,em,gs,ZcplcFdFdAhL,ZcplcFdFdAhR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_FdToFdAh(MLambda,em,gs,cplcFdFdAhL,cplcFdFdAhR,MAh,            & 
& MFd,MRPFdToFdAh,MRGFdToFdAh)
...
Call Amplitude_WAVE_THDMII_FdToFdAh(cplcFdFdAhL,cplcFdFdAhR,ctcplcFdFdAhL,            & 
& ctcplcFdFdAhR,MAh,MAh2,MFd,MFd2,ZfAh,ZfDL,ZfDR,AmpWaveFdToFdAh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FdToFdAh(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_FdToFdAh(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,            & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,        & 
& cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,               & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,           & 
& cplcFuFdcVWmR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,AmpVertexIRdrFdToFdAh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_FdToFdAh(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,               & 
...
& cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,               & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,           & 
& cplcFuFdcVWmR,cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,AmpVertexIRosFdToFdAh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_FdToFdhh(cplcFdFdhhL,cplcFdFdhhR,MFd,Mhh,MFd2,             & 
& Mhh2,AmpTreeFdToFdhh)

  Else 
Call Amplitude_Tree_THDMII_FdToFdhh(ZcplcFdFdhhL,ZcplcFdFdhhR,MFd,Mhh,MFd2,           & 
& Mhh2,AmpTreeFdToFdhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_FdToFdhh(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,MFdOS,          & 
& MhhOS,MRPFdToFdhh,MRGFdToFdhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_FdToFdhh(MLambda,em,gs,ZcplcFdFdhhL,ZcplcFdFdhhR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_FdToFdhh(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,MFd,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_FdToFdhh(cplcFdFdhhL,cplcFdFdhhR,ctcplcFdFdhhL,            & 
& ctcplcFdFdhhR,MFd,MFd2,Mhh,Mhh2,ZfDL,ZfDR,Zfhh,AmpWaveFdToFdhh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FdToFdhh(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_FdToFdhh(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,            & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcFdFdAhL,               & 
& cplcFdFdAhR,cplAhhhhh,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,       & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,             & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,           & 
...
& cplhhVZVZ,AmpVertexIRdrFdToFdhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_FdToFdhh(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,               & 
& MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_FdToFdVZ(cplcFdFdVZL,cplcFdFdVZR,MFd,MVZ,MFd2,             & 
& MVZ2,AmpTreeFdToFdVZ)

  Else 
Call Amplitude_Tree_THDMII_FdToFdVZ(ZcplcFdFdVZL,ZcplcFdFdVZR,MFd,MVZ,MFd2,           & 
& MVZ2,AmpTreeFdToFdVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_FdToFdVZ(MLambda,em,gs,cplcFdFdVZL,cplcFdFdVZR,MFdOS,          & 
& MVZOS,MRPFdToFdVZ,MRGFdToFdVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_FdToFdVZ(MLambda,em,gs,ZcplcFdFdVZL,ZcplcFdFdVZR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_FdToFdVZ(MLambda,em,gs,cplcFdFdVZL,cplcFdFdVZR,MFd,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_FdToFdVZ(cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FdToFdVZ(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_FdToFdVZ(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,            & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,             & 
& cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,     & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,         & 
& cplcFdFuHmL,cplcFdFuHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,             & 
& cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRdrFdToFdVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_FdToFdVZ(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,               & 
& MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_FdToFuHm(cplcFdFuHmL,cplcFdFuHmR,MFd,MFu,MHm,              & 
& MFd2,MFu2,MHm2,AmpTreeFdToFuHm)

  Else 
Call Amplitude_Tree_THDMII_FdToFuHm(ZcplcFdFuHmL,ZcplcFdFuHmR,MFd,MFu,MHm,            & 
& MFd2,MFu2,MHm2,AmpTreeFdToFuHm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_FdToFuHm(MLambda,em,gs,cplcFdFuHmL,cplcFdFuHmR,MFdOS,          & 
& MFuOS,MHmOS,MRPFdToFuHm,MRGFdToFuHm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_FdToFuHm(MLambda,em,gs,ZcplcFdFuHmL,ZcplcFdFuHmR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_FdToFuHm(MLambda,em,gs,cplcFdFuHmL,cplcFdFuHmR,MFd,            & 
& MFu,MHm,MRPFdToFuHm,MRGFdToFuHm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_FdToFuHm(cplcFdFuHmL,cplcFdFuHmR,ctcplcFdFuHmL,            & 
& ctcplcFdFuHmR,MFd,MFd2,MFu,MFu2,MHm,MHm2,ZfDL,ZfDR,ZfHm,ZfUL,ZfUR,AmpWaveFdToFuHm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FdToFuHm(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_FdToFuHm(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,            & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,             & 
& cplcFuFuAhL,cplcFuFuAhR,cplAhHmcHm,cplAhHmcVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,    & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuhhL,               & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
...
& cplhhHmcVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplHmcVWmVZ,AmpVertexIRdrFdToFuHm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_FdToFuHm(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,               & 
& MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_FdToFuVWm(cplcFdFuVWmL,cplcFdFuVWmR,MFd,MFu,               & 
& MVWm,MFd2,MFu2,MVWm2,AmpTreeFdToFuVWm)

  Else 
Call Amplitude_Tree_THDMII_FdToFuVWm(ZcplcFdFuVWmL,ZcplcFdFuVWmR,MFd,MFu,             & 
& MVWm,MFd2,MFu2,MVWm2,AmpTreeFdToFuVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_FdToFuVWm(MLambda,em,gs,cplcFdFuVWmL,cplcFdFuVWmR,             & 
& MFdOS,MFuOS,MVWmOS,MRPFdToFuVWm,MRGFdToFuVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_FdToFuVWm(MLambda,em,gs,ZcplcFdFuVWmL,ZcplcFdFuVWmR,           & 
& MFdOS,MFuOS,MVWmOS,MRPFdToFuVWm,MRGFdToFuVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_FdToFuVWm(cplcFdFuVWmL,cplcFdFuVWmR,ctcplcFdFuVWmL,        & 
& ctcplcFdFuVWmR,MFd,MFd2,MFu,MFu2,MVWm,MVWm2,ZfDL,ZfDR,ZfUL,ZfUR,ZfVWm,AmpWaveFdToFuVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FdToFuVWm(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,              & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_FdToFuVWm(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,           & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,             & 
& cplcFuFuAhL,cplcFuFuAhR,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,               & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuhhL,               & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
...
& cplhhcVWmVWm,cplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRdrFdToFuVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_FdToFuVWm(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,              & 
& MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,             & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_THDMII_FdToFdVG(ZcplcFdFdVGL,ZcplcFdFdVGR,ctcplcFdFdVGL,          & 
& ctcplcFdFdVGR,MFdOS,MFd2OS,MVG,MVG2,ZfDL,ZfDR,ZfVG,AmpWaveFdToFdVG)

 Else 
Call Amplitude_WAVE_THDMII_FdToFdVG(cplcFdFdVGL,cplcFdFdVGR,ctcplcFdFdVGL,            & 
& ctcplcFdFdVGR,MFdOS,MFd2OS,MVG,MVG2,ZfDL,ZfDR,ZfVG,AmpWaveFdToFdVG)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_FdToFdVG(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,MVG,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FdToFdVG(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,             & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,               & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,         & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_THDMII_FdToFdVP(ZcplcFdFdVPL,ZcplcFdFdVPR,ZcplcFdFdVZL,           & 
...
& MFd2OS,MVP,MVP2,ZfDL,ZfDR,ZfVP,ZfVZVP,AmpWaveFdToFdVP)
 ...
 Else 
Call Amplitude_WAVE_THDMII_FdToFdVP(cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_FdToFdVP(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,MVG,              & 
& MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,          & 
& ZcplcFdFdAhL,ZcplcFdFdAhR,ZcplcFdFdhhL,ZcplcFdFdhhR,ZcplcFdFdVGL,ZcplcFdFdVGR,         & 
& ZcplcFdFdVPL,ZcplcFdFdVPR,ZcplcFdFdVZL,ZcplcFdFdVZR,ZcplcFuFdcHmL,ZcplcFuFdcHmR,       & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FdToFdVP(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,             & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,               & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,         & 
...
End Module Wrapper_OneLoopDecay_Fd_THDMII
