...
Module Wrapper_OneLoopDecay_Fe_THDMII
Use Model_Data_THDMII 
Use Kinematics 
Use OneLoopDecay_Fe_THDMII 
Use Control 
Use Settings 
...
Call Amplitude_Tree_THDMII_FeToFeAh(cplcFeFeAhL,cplcFeFeAhR,MAh,MFe,MAh2,             & 
& MFe2,AmpTreeFeToFeAh)

  Else 
Call Amplitude_Tree_THDMII_FeToFeAh(ZcplcFeFeAhL,ZcplcFeFeAhR,MAh,MFe,MAh2,           & 
& MFe2,AmpTreeFeToFeAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_FeToFeAh(MLambda,em,gs,cplcFeFeAhL,cplcFeFeAhR,MAhOS,          & 
& MFeOS,MRPFeToFeAh,MRGFeToFeAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_FeToFeAh(MLambda,em,gs,ZcplcFeFeAhL,ZcplcFeFeAhR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_FeToFeAh(MLambda,em,gs,cplcFeFeAhL,cplcFeFeAhR,MAh,            & 
& MFe,MRPFeToFeAh,MRGFeToFeAh)
...
Call Amplitude_WAVE_THDMII_FeToFeAh(cplcFeFeAhL,cplcFeFeAhR,ctcplcFeFeAhL,            & 
& ctcplcFeFeAhR,MAh,MAh2,MFe,MFe2,ZfAh,ZfEL,ZfER,AmpWaveFeToFeAh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FeToFeAh(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,MAh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_FeToFeAh(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,MAh2,           & 
& MFe2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFeFeAhL,cplcFeFeAhR,            & 
& cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFeFehhL,cplcFeFehhR,        & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,cplcFvFecHmR,             & 
& cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,         & 
& AmpVertexIRdrFeToFeAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_FeToFeAh(MAhOS,MFeOS,MhhOS,MHmOS,MVP,MVWmOS,          & 
...
& cplcFeFvVWmL,cplcFeFvVWmR,AmpVertexIRosFeToFeAh)
 ...
 ! DR and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_FeToFeAh(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,MAh2,           & 
& MFe2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,ZcplcFeFeAhL,ZcplcFeFeAhR,          & 
& cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFeFehhL,cplcFeFehhR,        & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,cplcFvFecHmR,             & 
& cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_FeToFehh(cplcFeFehhL,cplcFeFehhR,MFe,Mhh,MFe2,             & 
& Mhh2,AmpTreeFeToFehh)

  Else 
Call Amplitude_Tree_THDMII_FeToFehh(ZcplcFeFehhL,ZcplcFeFehhR,MFe,Mhh,MFe2,           & 
& Mhh2,AmpTreeFeToFehh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_FeToFehh(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,MFeOS,          & 
& MhhOS,MRPFeToFehh,MRGFeToFehh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_FeToFehh(MLambda,em,gs,ZcplcFeFehhL,ZcplcFeFehhR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_FeToFehh(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,MFe,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_FeToFehh(cplcFeFehhL,cplcFeFehhR,ctcplcFeFehhL,            & 
& ctcplcFeFehhR,MFe,MFe2,Mhh,Mhh2,ZfEL,ZfER,Zfhh,AmpWaveFeToFehh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FeToFehh(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,MAh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_FeToFehh(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,MAh2,           & 
& MFe2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcFeFeAhL,cplcFeFeAhR,cplAhhhhh,            & 
& cplAhhhVZ,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,     & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHmL,cplcFeFvHmR,         & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,   & 
& cplhhVZVZ,AmpVertexIRdrFeToFehh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_FeToFehh(MAhOS,MFeOS,MhhOS,MHmOS,MVP,MVWmOS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_FeToFeVZ(cplcFeFeVZL,cplcFeFeVZR,MFe,MVZ,MFe2,             & 
& MVZ2,AmpTreeFeToFeVZ)

  Else 
Call Amplitude_Tree_THDMII_FeToFeVZ(ZcplcFeFeVZL,ZcplcFeFeVZR,MFe,MVZ,MFe2,           & 
& MVZ2,AmpTreeFeToFeVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_FeToFeVZ(MLambda,em,gs,cplcFeFeVZL,cplcFeFeVZR,MFeOS,          & 
& MVZOS,MRPFeToFeVZ,MRGFeToFeVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_FeToFeVZ(MLambda,em,gs,ZcplcFeFeVZL,ZcplcFeFeVZR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_FeToFeVZ(MLambda,em,gs,cplcFeFeVZL,cplcFeFeVZR,MFe,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_FeToFeVZ(cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FeToFeVZ(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,MAh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_FeToFeVZ(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,MAh2,           & 
& MFe2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVZ,cplcFeFehhL,          & 
& cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFvFecHmL,              & 
& cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,         & 
& cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,     & 
& cplcVWmVWmVZ,AmpVertexIRdrFeToFeVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_FeToFeVZ(MAhOS,MFeOS,MhhOS,MHmOS,MVP,MVWmOS,          & 
& MVZOS,MAh2OS,MFe2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,MVZ2OS,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplAhhhVZ,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,ZcplcFeFeVZL,ZcplcFeFeVZR,   & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHmL,cplcFeFvHmR,         & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,    & 
& cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRosFeToFeVZ)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_FeToFvHm(cplcFeFvHmL,cplcFeFvHmR,MFe,MHm,MFe2,             & 
& MHm2,AmpTreeFeToFvHm)

  Else 
Call Amplitude_Tree_THDMII_FeToFvHm(ZcplcFeFvHmL,ZcplcFeFvHmR,MFe,MHm,MFe2,           & 
& MHm2,AmpTreeFeToFvHm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_FeToFvHm(MLambda,em,gs,cplcFeFvHmL,cplcFeFvHmR,MFeOS,          & 
& MHmOS,MRPFeToFvHm,MRGFeToFvHm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_FeToFvHm(MLambda,em,gs,ZcplcFeFvHmL,ZcplcFeFvHmR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_FeToFvHm(MLambda,em,gs,cplcFeFvHmL,cplcFeFvHmR,MFe,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_FeToFvHm(cplcFeFvHmL,cplcFeFvHmR,ctcplcFeFvHmL,            & 
& ctcplcFeFvHmR,MFe,MFe2,MHm,MHm2,ZfEL,ZfER,ZfHm,ZfvL,AmpWaveFeToFvHm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FeToFvHm(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,MAh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_FeToFvHm(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,MAh2,           & 
& MFe2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplcFeFeAhL,cplcFeFeAhR,cplAhHmcHm,cplAhHmcVWm,         & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFvHmL,cplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,             & 
& cplhhHmcHm,cplhhHmcVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplHmcVWmVZ,AmpVertexIRdrFeToFvHm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_FeToFvHm(MAhOS,MFeOS,MhhOS,MHmOS,MVP,MVWmOS,          & 
& MVZOS,MAh2OS,MFe2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,MVZ2OS,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplAhHmcHm,cplAhHmcVWm,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,    & 
& cplcFeFeVZR,ZcplcFeFvHmL,ZcplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFvVZL,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_FeToFvVWm(cplcFeFvVWmL,cplcFeFvVWmR,MFe,MVWm,              & 
& MFe2,MVWm2,AmpTreeFeToFvVWm)

  Else 
Call Amplitude_Tree_THDMII_FeToFvVWm(ZcplcFeFvVWmL,ZcplcFeFvVWmR,MFe,MVWm,            & 
& MFe2,MVWm2,AmpTreeFeToFvVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_FeToFvVWm(MLambda,em,gs,cplcFeFvVWmL,cplcFeFvVWmR,             & 
& MFeOS,MVWmOS,MRPFeToFvVWm,MRGFeToFvVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_FeToFvVWm(MLambda,em,gs,ZcplcFeFvVWmL,ZcplcFeFvVWmR,           & 
& MFeOS,MVWmOS,MRPFeToFvVWm,MRGFeToFvVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_FeToFvVWm(cplcFeFvVWmL,cplcFeFvVWmR,ctcplcFeFvVWmL,        & 
& ctcplcFeFvVWmR,MFe,MFe2,MVWm,MVWm2,ZfEL,ZfER,ZfvL,ZfVWm,AmpWaveFeToFvVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FeToFvVWm(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,MAh2,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_FeToFvVWm(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,               & 
...
& AmpVertexIRdrFeToFvVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_FeToFvVWm(MAhOS,MFeOS,MhhOS,MHmOS,MVP,MVWmOS,         & 
& MVZOS,MAh2OS,MFe2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,MVZ2OS,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplAhcHmVWm,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,               & 
& cplcFeFeVZR,GosZcplcFeFvHmL,GosZcplcFeFvHmR,ZcplcFeFvVWmL,ZcplcFeFvVWmR,               & 
...
& MVZOS,MAh2OS,MFe2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,MVZ2OS,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplAhcHmVWm,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,               & 
& cplcFeFeVZR,GcplcFeFvHmL,GcplcFeFvHmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFvVZL,           & 
& cplcFvFvVZR,cplhhcHmVWm,cplhhcVWmVWm,GcplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,            & 
& cplcVWmVWmVZ,AmpVertexIRosFeToFvVWm)
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_THDMII_FeToFeVP(ZcplcFeFeVPL,ZcplcFeFeVPR,ZcplcFeFeVZL,           & 
...
& MFe2OS,MVP,MVP2,ZfEL,ZfER,ZfVP,ZfVZVP,AmpWaveFeToFeVP)
 ...
 Else 
Call Amplitude_WAVE_THDMII_FeToFeVP(cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_FeToFeVP(MAhOS,MFeOS,MhhOS,MHmOS,MVP,MVWmOS,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FeToFeVP(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,MAh2,              & 
...
End Module Wrapper_OneLoopDecay_Fe_THDMII
