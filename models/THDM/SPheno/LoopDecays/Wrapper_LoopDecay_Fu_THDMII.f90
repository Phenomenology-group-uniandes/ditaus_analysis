...
Module Wrapper_OneLoopDecay_Fu_THDMII
Use Model_Data_THDMII 
Use Kinematics 
Use OneLoopDecay_Fu_THDMII 
Use Control 
Use Settings 
...
Call Amplitude_Tree_THDMII_FuToFuAh(cplcFuFuAhL,cplcFuFuAhR,MAh,MFu,MAh2,             & 
& MFu2,AmpTreeFuToFuAh)

  Else 
Call Amplitude_Tree_THDMII_FuToFuAh(ZcplcFuFuAhL,ZcplcFuFuAhR,MAh,MFu,MAh2,           & 
& MFu2,AmpTreeFuToFuAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_FuToFuAh(MLambda,em,gs,cplcFuFuAhL,cplcFuFuAhR,MAhOS,          & 
& MFuOS,MRPFuToFuAh,MRGFuToFuAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_FuToFuAh(MLambda,em,gs,ZcplcFuFuAhL,ZcplcFuFuAhR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_FuToFuAh(MLambda,em,gs,cplcFuFuAhL,cplcFuFuAhR,MAh,            & 
...
Call Amplitude_WAVE_THDMII_FuToFuAh(cplcFuFuAhL,cplcFuFuAhR,ctcplcFuFuAhL,            & 
& ctcplcFuFuAhR,MAh,MAh2,MFu,MFu2,ZfAh,ZfUL,ZfUR,AmpWaveFuToFuAh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FuToFuAh(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_FuToFuAh(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,            & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,        & 
& cplAhcHmVWm,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,         & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
& cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,AmpVertexIRdrFuToFuAh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_FuToFuAh(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,               & 
...
& cplAhcHmVWm,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,         & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,               & 
& cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,AmpVertexIRosFuToFuAh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_FuToFdcHm(cplcFuFdcHmL,cplcFuFdcHmR,MFd,MFu,               & 
& MHm,MFd2,MFu2,MHm2,AmpTreeFuToFdcHm)

  Else 
Call Amplitude_Tree_THDMII_FuToFdcHm(ZcplcFuFdcHmL,ZcplcFuFdcHmR,MFd,MFu,             & 
& MHm,MFd2,MFu2,MHm2,AmpTreeFuToFdcHm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_FuToFdcHm(MLambda,em,gs,cplcFuFdcHmL,cplcFuFdcHmR,             & 
& MFdOS,MFuOS,MHmOS,MRPFuToFdcHm,MRGFuToFdcHm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_FuToFdcHm(MLambda,em,gs,ZcplcFuFdcHmL,ZcplcFuFdcHmR,           & 
& MFdOS,MFuOS,MHmOS,MRPFuToFdcHm,MRGFuToFdcHm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_FuToFdcHm(cplcFuFdcHmL,cplcFuFdcHmR,ctcplcFuFdcHmL,        & 
& ctcplcFuFdcHmR,MFd,MFd2,MFu,MFu2,MHm,MHm2,ZfDL,ZfDR,ZfHm,ZfUL,ZfUR,AmpWaveFuToFdcHm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FuToFdcHm(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_FuToFdcHm(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,           & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,             & 
& cplcFuFuAhL,cplcFuFuAhR,cplAhHmcHm,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,    & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,          & 
...
& cplHmcHmVP,cplHmcHmVZ,cplcHmVPVWm,cplcHmVWmVZ,AmpVertexIRdrFuToFdcHm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_FuToFdcHm(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,              & 
& MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,MFd,MFu,            & 
& MVWm,MFd2,MFu2,MVWm2,AmpTreeFuToFdcVWm)

  Else 
Call Amplitude_Tree_THDMII_FuToFdcVWm(ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,MFd,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_FuToFdcVWm(MLambda,em,gs,cplcFuFdcVWmL,cplcFuFdcVWmR,          & 
& MFdOS,MFuOS,MVWmOS,MRPFuToFdcVWm,MRGFuToFdcVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_FuToFdcVWm(MLambda,em,gs,ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,        & 
& MFdOS,MFuOS,MVWmOS,MRPFuToFdcVWm,MRGFuToFdcVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,ctcplcFuFdcVWmL,    & 
& ctcplcFuFdcVWmR,MFd,MFd2,MFu,MFu2,MVWm,MVWm2,ZfDL,ZfDR,ZfUL,ZfUR,ZfVWm,AmpWaveFuToFdcVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FuToFdcVWm(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,             & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_FuToFdcVWm(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,               & 
...
& cplhhcVWmVWm,cplHmcVWmVP,cplHmcVWmVZ,cplcVWmVPVWm,cplcVWmVWmVZ,AmpVertexIRdrFuToFdcVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_FuToFdcVWm(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,             & 
& MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,MFu2,             & 
& Mhh2,AmpTreeFuToFuhh)

  Else 
Call Amplitude_Tree_THDMII_FuToFuhh(ZcplcFuFuhhL,ZcplcFuFuhhR,MFu,Mhh,MFu2,           & 
& Mhh2,AmpTreeFuToFuhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,MFuOS,          & 
& MhhOS,MRPFuToFuhh,MRGFuToFuhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_FuToFuhh(MLambda,em,gs,ZcplcFuFuhhL,ZcplcFuFuhhR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,MFu,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,            & 
& ctcplcFuFuhhR,MFu,MFu2,Mhh,Mhh2,Zfhh,ZfUL,ZfUR,AmpWaveFuToFuhh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FuToFuhh(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_FuToFuhh(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,            & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcFuFuAhL,               & 
& cplcFuFuAhR,cplAhhhhh,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcHmL,cplcFuFdcHmR,     & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,           & 
& cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,             & 
...
& cplhhVZVZ,AmpVertexIRdrFuToFuhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_FuToFuhh(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,               & 
& MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_FuToFuVZ(cplcFuFuVZL,cplcFuFuVZR,MFu,MVZ,MFu2,             & 
& MVZ2,AmpTreeFuToFuVZ)

  Else 
Call Amplitude_Tree_THDMII_FuToFuVZ(ZcplcFuFuVZL,ZcplcFuFuVZR,MFu,MVZ,MFu2,           & 
& MVZ2,AmpTreeFuToFuVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,MFuOS,          & 
& MVZOS,MRPFuToFuVZ,MRGFuToFuVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_FuToFuVZ(MLambda,em,gs,ZcplcFuFuVZL,ZcplcFuFuVZR,              & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,MFu,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_FuToFuVZ(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FuToFuVZ(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_FuToFuVZ(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,            & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,             & 
& cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFuFdcVWmL,             & 
& cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVGL,             & 
& cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,             & 
& cplcFuFuVZR,cplhhVZVZ,cplHmcHmVZ,cplHmcVWmVZ,cplcHmVWmVZ,cplcVWmVWmVZ,AmpVertexIRdrFuToFuVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_FuToFuVZ(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,               & 
& MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,             & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_THDMII_FuToFuVG(ZcplcFuFuVGL,ZcplcFuFuVGR,ctcplcFuFuVGL,          & 
& ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)

 Else 
Call Amplitude_WAVE_THDMII_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,ctcplcFuFuVGL,            & 
& ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_FuToFuVG(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,MVG,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FuToFuVG(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,             & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_THDMII_FuToFuVP(ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFuFuVZL,           & 
...
& MFu2OS,MVP,MVP2,ZfUL,ZfUR,ZfVP,ZfVZVP,AmpWaveFuToFuVP)
 ...
 Else 
Call Amplitude_WAVE_THDMII_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_FuToFuVP(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,MVG,              & 
& MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,MVZ2OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_FuToFuVP(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,               & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,             & 
...
End Module Wrapper_OneLoopDecay_Fu_THDMII
