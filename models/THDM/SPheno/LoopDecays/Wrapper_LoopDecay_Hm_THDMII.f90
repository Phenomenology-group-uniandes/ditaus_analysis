...
Module Wrapper_OneLoopDecay_Hm_THDMII
Use Model_Data_THDMII 
Use Kinematics 
Use OneLoopDecay_Hm_THDMII 
Use Control 
Use Settings 
...
Call Amplitude_Tree_THDMII_HmToHmAh(cplAhHmcHm,MAh,MHm,MAh2,MHm2,AmpTreeHmToHmAh)

  Else 
Call Amplitude_Tree_THDMII_HmToHmAh(ZcplAhHmcHm,MAh,MHm,MAh2,MHm2,AmpTreeHmToHmAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_HmToHmAh(MLambda,em,gs,cplAhHmcHm,MAhOS,MHmOS,MRPHmToHmAh,     & 
& MRGHmToHmAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_HmToHmAh(MLambda,em,gs,ZcplAhHmcHm,MAhOS,MHmOS,MRPHmToHmAh,    & 
& MRGHmToHmAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_HmToHmAh(MLambda,em,gs,cplAhHmcHm,MAh,MHm,MRPHmToHmAh,         & 
& MRGHmToHmAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_HmToHmAh(MLambda,em,gs,ZcplAhHmcHm,MAh,MHm,MRPHmToHmAh,        & 
& MRGHmToHmAh)
...
Call Amplitude_WAVE_THDMII_HmToHmAh(cplAhHmcHm,ctcplAhHmcHm,MAh,MAh2,MHm,             & 
& MHm2,ZfAh,ZfHm,AmpWaveHmToHmAh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_HmToHmAh(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_HmToHmAh(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,            & 
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFuFdcHmL,    & 
& cplcFuFdcHmR,cplcFvFecHmL,cplcFvFecHmR,cplcFdFuHmL,cplcFdFuHmR,cplcFeFvHmL,            & 
...
& cplhhHmcVWm,cplhhcHmVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplHmcVWmVZ,cplcHmVPVWm,     & 
& cplcHmVWmVZ,cplAhAhHmcHm1,cplAhhhHmcHm1,cplAhHmcVWmVP1,cplAhHmcVWmVZ1,cplAhcHmVPVWm1,  & 
& cplAhcHmVWmVZ1,cplhhhhHmcHm1,cplHmHmcHmcHm1,AmpVertexIRdrHmToHmAh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_HmToHmAh(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,               & 
...
& cplhhHmcVWm,cplhhcHmVWm,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplHmcVWmVZ,cplcHmVPVWm,     & 
& cplcHmVWmVZ,cplAhAhHmcHm1,cplAhhhHmcHm1,cplAhHmcVWmVP1,cplAhHmcVWmVZ1,cplAhcHmVPVWm1,  & 
& cplAhcHmVWmVZ1,cplhhhhHmcHm1,cplHmHmcHmcHm1,AmpVertexIRosHmToHmAh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_HmToAhVWm(cplAhcHmVWm,MAh,MHm,MVWm,MAh2,MHm2,              & 
& MVWm2,AmpTreeHmToAhVWm)

  Else 
Call Amplitude_Tree_THDMII_HmToAhVWm(ZcplAhcHmVWm,MAh,MHm,MVWm,MAh2,MHm2,             & 
& MVWm2,AmpTreeHmToAhVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_HmToAhVWm(MLambda,em,gs,cplAhcHmVWm,MAhOS,MHmOS,               & 
& MVWmOS,MRPHmToAhVWm,MRGHmToAhVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_HmToAhVWm(MLambda,em,gs,ZcplAhcHmVWm,MAhOS,MHmOS,              & 
& MVWmOS,MRPHmToAhVWm,MRGHmToAhVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_HmToAhVWm(MLambda,em,gs,cplAhcHmVWm,MAh,MHm,MVWm,              & 
& MRPHmToAhVWm,MRGHmToAhVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_HmToAhVWm(MLambda,em,gs,ZcplAhcHmVWm,MAh,MHm,MVWm,             & 
& MRPHmToAhVWm,MRGHmToAhVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_HmToAhVWm(cplAhcHmVWm,ctcplAhcHmVWm,MAh,MAh2,              & 
& MHm,MHm2,MVWm,MVWm2,ZfAh,ZfHm,ZfVWm,AmpWaveHmToAhVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_HmToAhVWm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,              & 
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFuFdcHmL,    & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_HmToAhVWm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,           & 
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFuFdcHmL,    & 
& cplcFuFdcHmR,cplcFvFecHmL,cplcFvFecHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFvVWmL,         & 
...
& cplcgWpCgZcHm,cplhhHmcHm,cplhhcHmVWm,cplhhcVWmVWm,cplHmcHmVP,cplHmcHmVZ,               & 
& cplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhAhcVWmVWm1,cplAhcHmVPVWm1,      & 
& cplAhcHmVWmVZ1,cplhhcHmVWmVZ1,cplHmcHmcVWmVWm1,AmpVertexIRdrHmToAhVWm)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_HmToAhVWm(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,              & 
& MHmOS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,         & 
& MVZ2OS,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,            & 
& cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,               & 
...
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,     & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,GZcplAhHmcHm,cplAhHmcVWm,ZcplAhcHmVWm,              & 
...
& cplHmcHmVZ,GZcplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhAhcVWmVWm1,        & 
...
& cplcgWpCgZcHm,cplhhHmcHm,cplhhcHmVWm,cplhhcVWmVWm,cplHmcHmVP,cplHmcHmVZ,               & 
& cplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhAhcVWmVWm1,cplAhcHmVPVWm1,      & 
& cplAhcHmVWmVZ1,cplhhcHmVWmVZ1,cplHmcHmcVWmVWm1,AmpVertexIRosHmToAhVWm)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_HmTocFuFd(cplcFuFdcHmL,cplcFuFdcHmR,MFd,MFu,               & 
& MHm,MFd2,MFu2,MHm2,AmpTreeHmTocFuFd)

  Else 
Call Amplitude_Tree_THDMII_HmTocFuFd(ZcplcFuFdcHmL,ZcplcFuFdcHmR,MFd,MFu,             & 
& MHm,MFd2,MFu2,MHm2,AmpTreeHmTocFuFd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_HmTocFuFd(MLambda,em,gs,cplcFuFdcHmL,cplcFuFdcHmR,             & 
& MFdOS,MFuOS,MHmOS,MRPHmTocFuFd,MRGHmTocFuFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_HmTocFuFd(MLambda,em,gs,ZcplcFuFdcHmL,ZcplcFuFdcHmR,           & 
& MFdOS,MFuOS,MHmOS,MRPHmTocFuFd,MRGHmTocFuFd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_HmTocFuFd(cplcFuFdcHmL,cplcFuFdcHmR,ctcplcFuFdcHmL,        & 
& ctcplcFuFdcHmR,MFd,MFd2,MFu,MFu2,MHm,MHm2,ZfDL,ZfDR,ZfHm,ZfUL,ZfUR,AmpWaveHmTocFuFd)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_HmTocFuFd(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_HmTocFuFd(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,           & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,             & 
& cplcFuFuAhL,cplcFuFuAhR,cplAhHmcHm,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,    & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,              & 
& cplcFuFdcHmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVGL,          & 
...
& cplHmcHmVP,cplHmcHmVZ,cplcHmVPVWm,cplcHmVWmVZ,AmpVertexIRdrHmTocFuFd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_HmTocFuFd(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_HmTocFvFe(cplcFvFecHmL,cplcFvFecHmR,MFe,MHm,               & 
& MFe2,MHm2,AmpTreeHmTocFvFe)

  Else 
Call Amplitude_Tree_THDMII_HmTocFvFe(ZcplcFvFecHmL,ZcplcFvFecHmR,MFe,MHm,             & 
& MFe2,MHm2,AmpTreeHmTocFvFe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_HmTocFvFe(MLambda,em,gs,cplcFvFecHmL,cplcFvFecHmR,             & 
& MFeOS,MHmOS,MRPHmTocFvFe,MRGHmTocFvFe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_HmTocFvFe(MLambda,em,gs,ZcplcFvFecHmL,ZcplcFvFecHmR,           & 
& MFeOS,MHmOS,MRPHmTocFvFe,MRGHmTocFvFe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_HmTocFvFe(cplcFvFecHmL,cplcFvFecHmR,ctcplcFvFecHmL,        & 
& ctcplcFvFecHmR,MFe,MFe2,MHm,MHm2,ZfEL,ZfER,ZfHm,ZfvL,AmpWaveHmTocFvFe)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_HmTocFvFe(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,MAh2,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_HmTocFvFe(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,               & 
...
& cplhhHmcHm,cplhhcHmVWm,cplHmcHmVP,cplHmcHmVZ,cplcHmVPVWm,cplcHmVWmVZ,AmpVertexIRdrHmTocFvFe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_HmTocFvFe(MAhOS,MFeOS,MhhOS,MHmOS,MVP,MVWmOS,         & 
& MVZOS,MAh2OS,MFe2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,MVZ2OS,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplAhHmcHm,cplAhcHmVWm,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,    & 
& cplcFeFeVZR,ZcplcFvFecHmL,ZcplcFvFecHmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,       & 
& cplcFvFvVZR,cplhhHmcHm,cplhhcHmVWm,cplHmcHmVP,cplHmcHmVZ,cplcHmVPVWm,cplcHmVWmVZ,      & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_HmToHmhh(cplhhHmcHm,Mhh,MHm,Mhh2,MHm2,AmpTreeHmToHmhh)

  Else 
Call Amplitude_Tree_THDMII_HmToHmhh(ZcplhhHmcHm,Mhh,MHm,Mhh2,MHm2,AmpTreeHmToHmhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_HmToHmhh(MLambda,em,gs,cplhhHmcHm,MhhOS,MHmOS,MRPHmToHmhh,     & 
& MRGHmToHmhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_HmToHmhh(MLambda,em,gs,ZcplhhHmcHm,MhhOS,MHmOS,MRPHmToHmhh,    & 
& MRGHmToHmhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_HmToHmhh(MLambda,em,gs,cplhhHmcHm,Mhh,MHm,MRPHmToHmhh,         & 
& MRGHmToHmhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_HmToHmhh(MLambda,em,gs,ZcplhhHmcHm,Mhh,MHm,MRPHmToHmhh,        & 
& MRGHmToHmhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_HmToHmhh(cplhhHmcHm,ctcplhhHmcHm,Mhh,Mhh2,MHm,             & 
& MHm2,Zfhh,ZfHm,AmpWaveHmToHmhh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_HmToHmhh(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_HmToHmhh(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,            & 
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,       & 
& cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcHmL,               & 
& cplcFuFdcHmR,cplcFeFehhL,cplcFeFehhR,cplcFvFecHmL,cplcFvFecHmR,cplcFuFuhhL,            & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFeFvHmL,cplcFeFvHmR,cplcgWmgWmhh,              & 
...
& cplhhcHmVWmVZ1,cplHmHmcHmcHm1,cplHmcHmcVWmVWm1,cplHmcHmVZVZ1,AmpVertexIRdrHmToHmhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_HmToHmhh(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,               & 
& MHmOS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_HmTohhVWm(cplhhcHmVWm,Mhh,MHm,MVWm,Mhh2,MHm2,              & 
& MVWm2,AmpTreeHmTohhVWm)

  Else 
Call Amplitude_Tree_THDMII_HmTohhVWm(ZcplhhcHmVWm,Mhh,MHm,MVWm,Mhh2,MHm2,             & 
& MVWm2,AmpTreeHmTohhVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_HmTohhVWm(MLambda,em,gs,cplhhcHmVWm,MhhOS,MHmOS,               & 
& MVWmOS,MRPHmTohhVWm,MRGHmTohhVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_HmTohhVWm(MLambda,em,gs,ZcplhhcHmVWm,MhhOS,MHmOS,              & 
& MVWmOS,MRPHmTohhVWm,MRGHmTohhVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_HmTohhVWm(MLambda,em,gs,cplhhcHmVWm,Mhh,MHm,MVWm,              & 
& MRPHmTohhVWm,MRGHmTohhVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_HmTohhVWm(MLambda,em,gs,ZcplhhcHmVWm,Mhh,MHm,MVWm,             & 
& MRPHmTohhVWm,MRGHmTohhVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_HmTohhVWm(cplhhcHmVWm,ctcplhhcHmVWm,Mhh,Mhh2,              & 
& MHm,MHm2,MVWm,MVWm2,Zfhh,ZfHm,ZfVWm,AmpWaveHmTohhVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_HmTohhVWm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,              & 
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,       & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_HmTohhVWm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,           & 
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,       & 
& cplAhHmcHm,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcHmL,cplcFuFdcHmR,              & 
& cplcFeFehhL,cplcFeFehhR,cplcFvFecHmL,cplcFvFecHmR,cplcFuFuhhL,cplcFuFuhhR,             & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcgZgAhh,cplcgWpCgAcHm,          & 
...
& cplHmcHmcVWmVWm1,AmpVertexIRdrHmTohhVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_HmTohhVWm(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,              & 
& MHmOS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_HmToHmVZ(cplHmcHmVZ,MHm,MVZ,MHm2,MVZ2,AmpTreeHmToHmVZ)

  Else 
Call Amplitude_Tree_THDMII_HmToHmVZ(ZcplHmcHmVZ,MHm,MVZ,MHm2,MVZ2,AmpTreeHmToHmVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_HmToHmVZ(MLambda,em,gs,cplHmcHmVZ,MHmOS,MVZOS,MRPHmToHmVZ,     & 
& MRGHmToHmVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_HmToHmVZ(MLambda,em,gs,ZcplHmcHmVZ,MHmOS,MVZOS,MRPHmToHmVZ,    & 
& MRGHmToHmVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_HmToHmVZ(MLambda,em,gs,cplHmcHmVZ,MHm,MVZ,MRPHmToHmVZ,         & 
& MRGHmToHmVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_HmToHmVZ(MLambda,em,gs,ZcplHmcHmVZ,MHm,MVZ,MRPHmToHmVZ,        & 
& MRGHmToHmVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_HmToHmVZ(cplHmcHmVP,cplHmcHmVZ,ctcplHmcHmVP,               & 
& ctcplHmcHmVZ,MHm,MHm2,MVP,MVP2,MVZ,MVZ2,ZfHm,ZfVPVZ,ZfVZ,AmpWaveHmToHmVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_HmToHmVZ(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_HmToHmVZ(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,            & 
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,    & 
& cplAhcHmVWm,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFeFeVZL,             & 
& cplcFeFeVZR,cplcFvFecHmL,cplcFvFecHmR,cplcFdFuHmL,cplcFdFuHmR,cplcFuFuVZL,             & 
& cplcFuFuVZR,cplcFeFvHmL,cplcFeFvHmR,cplcFvFvVZL,cplcFvFvVZR,cplcgWmgWmVZ,              & 
...
& cplhhHmcVWm,cplhhcHmVWm,cplhhVZVZ,cplHmcHmVP,cplHmcVWmVP,cplHmcHmVZ,cplHmcVWmVZ,       & 
& cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhHmcVWmVZ1,cplAhcHmVWmVZ1,cplhhHmcVWmVZ1,     & 
& cplhhcHmVWmVZ1,cplHmcHmVPVZ1,cplHmcHmVZVZ1,AmpVertexIRdrHmToHmVZ)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_HmToHmVZ(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,               & 
& MHmOS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,         & 
...
& cplcHmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhHmcVWmVZ1,cplAhcHmVWmVZ1,cplhhHmcVWmVZ1,     & 
& cplhhcHmVWmVZ1,cplHmcHmVPVZ1,cplHmcHmVZVZ1,AmpVertexIRosHmToHmVZ)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_HmToVZVWm(cplcHmVWmVZ,MHm,MVWm,MVZ,MHm2,MVWm2,             & 
& MVZ2,AmpTreeHmToVZVWm)

  Else 
Call Amplitude_Tree_THDMII_HmToVZVWm(ZcplcHmVWmVZ,MHm,MVWm,MVZ,MHm2,MVWm2,            & 
& MVZ2,AmpTreeHmToVZVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_HmToVZVWm(MLambda,em,gs,cplcHmVWmVZ,MHmOS,MVWmOS,              & 
& MVZOS,MRPHmToVZVWm,MRGHmToVZVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_HmToVZVWm(MLambda,em,gs,ZcplcHmVWmVZ,MHmOS,MVWmOS,             & 
& MVZOS,MRPHmToVZVWm,MRGHmToVZVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_HmToVZVWm(MLambda,em,gs,cplcHmVWmVZ,MHm,MVWm,MVZ,              & 
& MRPHmToVZVWm,MRGHmToVZVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_HmToVZVWm(MLambda,em,gs,ZcplcHmVWmVZ,MHm,MVWm,MVZ,             & 
& MRPHmToVZVWm,MRGHmToVZVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_HmToVZVWm(cplcHmVPVWm,cplcHmVWmVZ,ctcplcHmVPVWm,           & 
& ctcplcHmVWmVZ,MHm,MHm2,MVP,MVP2,MVWm,MVWm2,MVZ,MVZ2,ZfHm,ZfVWm,ZfVZ,AmpWaveHmToVZVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_HmToVZVWm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_HmToVZVWm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,           & 
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhhhVZ,cplAhHmcHm,cplAhcHmVWm,    & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,cplcFeFeVZL,cplcFeFeVZR,             & 
& cplcFvFecHmL,cplcFvFecHmR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,           & 
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcgWpCgAcHm,cplcgWmgWmVZ,          & 
...
& cplcHmVPVWm,cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhcHmVWmVZ1,cplhhcHmVWmVZ1,       & 
& cplHmcHmVPVZ1,cplHmcHmcVWmVWm1,cplHmcHmVZVZ1,cplcVWmVPVWmVZ3Q,cplcVWmVPVWmVZ2Q,        & 
& cplcVWmVPVWmVZ1Q,cplcVWmVWmVZVZ2Q,cplcVWmVWmVZVZ3Q,cplcVWmVWmVZVZ1Q,AmpVertexIRdrHmToVZVWm)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_HmToVZVWm(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,              & 
& MHmOS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,         & 
...
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcgWpCgAcHm,cplcgWmgWmVZ,          & 
& cplcgZgWmcHm,cplcgAgWpCVWm,cplcgZgWpCVWm,cplcgWpCgWpCVZ,cplcgWmgZVWm,cplcgWpCgZcHm,    & 
& cplhhHmcHm,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplHmcHmVP,GZcplHmcHmVZ,cplHmcVWmVZ,     & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_THDMII_HmToHmVP(cplHmcHmVP,cplHmcHmVZ,ctcplHmcHmVP,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_HmToHmVP(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_HmToHmVP(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,               & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_THDMII_HmToVPVWm(cplcHmVPVWm,cplcHmVWmVZ,ctcplcHmVPVWm,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_HmToVPVWm(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,           & 
& MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,               & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_HmToVPVWm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,              & 
...
End Module Wrapper_OneLoopDecay_Hm_THDMII
