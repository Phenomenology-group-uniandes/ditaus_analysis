...
! ------------------------------------------------------------------------------  
! File created at 14:24 on 14.6.2024   
! ----------------------------------------------------------------------  
 
 
Module Wrapper_OneLoopDecay_hh_THDMII
Use Model_Data_THDMII 
Use Kinematics 
Use OneLoopDecay_hh_THDMII 
Use Control 
Use Settings 
...
& M222,vd,vu,dg1,dg2,dg3,dM12,dYu,dYd,dYe,dLam5,dM112,dM222,dLam1,dLam4,dLam3,           & 
...
Complex(dp),Intent(in) :: dM12,dYu(3,3),dYd(3,3),dYe(3,3),dLam5,dM112,dM222,dLam1,dLam4,dLam3,dLam2,            & 
...
Call Amplitude_Tree_THDMII_hhToAhAh(cplAhAhhh,MAh,Mhh,MAh2,Mhh2,AmpTreehhToAhAh)

  Else 
Call Amplitude_Tree_THDMII_hhToAhAh(ZcplAhAhhh,MAh,Mhh,MAh2,Mhh2,AmpTreehhToAhAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_hhToAhAh(MLambda,em,gs,cplAhAhhh,MAhOS,MhhOS,MRPhhToAhAh,      & 
& MRGhhToAhAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_hhToAhAh(MLambda,em,gs,ZcplAhAhhh,MAhOS,MhhOS,MRPhhToAhAh,     & 
& MRGhhToAhAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_hhToAhAh(MLambda,em,gs,cplAhAhhh,MAh,Mhh,MRPhhToAhAh,          & 
& MRGhhToAhAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_hhToAhAh(MLambda,em,gs,ZcplAhAhhh,MAh,Mhh,MRPhhToAhAh,         & 
& MRGhhToAhAh)
...
Call Amplitude_WAVE_THDMII_hhToAhAh(cplAhAhhh,ctcplAhAhhh,MAh,MAh2,Mhh,               & 
& Mhh2,ZfAh,Zfhh,AmpWavehhToAhAh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhToAhAh(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_hhToAhAh(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,            & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,              & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWmgWmhh,              & 
...
& cplAhAhVZVZ1,cplAhhhhhhh1,cplAhhhHmcHm1,AmpVertexIRdrhhToAhAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_hhToAhAh(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,               & 
...
& cplAhAhHmcHm1,cplAhAhcVWmVWm1,cplAhAhVZVZ1,cplAhhhhhhh1,cplAhhhHmcHm1,AmpVertexIRoshhToAhAh)
 ...
 ! DR and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_hhToAhAh(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,            & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhAh,ZcplAhAhhh,cplcFdFdAhL,             & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWmgWmhh,              & 
& cplcgWpCgWpChh,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_hhTohhAh(cplAhhhhh,MAh,Mhh,MAh2,Mhh2,AmpTreehhTohhAh)

  Else 
Call Amplitude_Tree_THDMII_hhTohhAh(ZcplAhhhhh,MAh,Mhh,MAh2,Mhh2,AmpTreehhTohhAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_hhTohhAh(MLambda,em,gs,cplAhhhhh,MAhOS,MhhOS,MRPhhTohhAh,      & 
& MRGhhTohhAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_hhTohhAh(MLambda,em,gs,ZcplAhhhhh,MAhOS,MhhOS,MRPhhTohhAh,     & 
& MRGhhTohhAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_hhTohhAh(MLambda,em,gs,cplAhhhhh,MAh,Mhh,MRPhhTohhAh,          & 
& MRGhhTohhAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_hhTohhAh(MLambda,em,gs,ZcplAhhhhh,MAh,Mhh,MRPhhTohhAh,         & 
& MRGhhTohhAh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_hhTohhAh(cplAhhhhh,ctcplAhhhhh,MAh,MAh2,Mhh,               & 
& Mhh2,ZfAh,Zfhh,AmpWavehhTohhAh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhTohhAh(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,               & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,              & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWmgWmhh,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_hhTohhAh(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,            & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,              & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWmgWmhh,              & 
...
& AmpVertexIRdrhhTohhAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_hhTohhAh(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,               & 
& MHmOS,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVWm2OS,MVZ2OS,           & 
& cplAhAhAh,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,       & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_hhToAhVZ(cplAhhhVZ,MAh,Mhh,MVZ,MAh2,Mhh2,MVZ2,             & 
& AmpTreehhToAhVZ)

  Else 
Call Amplitude_Tree_THDMII_hhToAhVZ(ZcplAhhhVZ,MAh,Mhh,MVZ,MAh2,Mhh2,MVZ2,            & 
& AmpTreehhToAhVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_hhToAhVZ(MLambda,em,gs,cplAhhhVZ,MAhOS,MhhOS,MVZOS,            & 
& MRPhhToAhVZ,MRGhhToAhVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_hhToAhVZ(MLambda,em,gs,ZcplAhhhVZ,MAhOS,MhhOS,MVZOS,           & 
& MRPhhToAhVZ,MRGhhToAhVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_hhToAhVZ(MLambda,em,gs,cplAhhhVZ,MAh,Mhh,MVZ,MRPhhToAhVZ,      & 
& MRGhhToAhVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_hhToAhVZ(MLambda,em,gs,ZcplAhhhVZ,MAh,Mhh,MVZ,MRPhhToAhVZ,     & 
& MRGhhToAhVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_hhToAhVZ(cplAhhhVZ,ctcplAhhhVZ,MAh,MAh2,Mhh,               & 
& Mhh2,MVZ,MVZ2,ZfAh,Zfhh,ZfVZ,AmpWavehhToAhVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhToAhVZ(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,               & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,              & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,     & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_hhToAhVZ(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,            & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhAh,cplAhAhhh,cplcFdFdAhL,              & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,              & 
& cplcgWpCgWpCAh,cplAhhhhh,cplAhhhVZ,cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,               & 
...
& AmpVertexIRdrhhToAhVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_hhToAhVZ(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,               & 
& MHmOS,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVWm2OS,MVZ2OS,           & 
& cplAhAhAh,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,       & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_hhTocFdFd(cplcFdFdhhL,cplcFdFdhhR,MFd,Mhh,MFd2,            & 
& Mhh2,AmpTreehhTocFdFd)

  Else 
Call Amplitude_Tree_THDMII_hhTocFdFd(ZcplcFdFdhhL,ZcplcFdFdhhR,MFd,Mhh,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_hhTocFdFd(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,               & 
& MFdOS,MhhOS,MRPhhTocFdFd,MRGhhTocFdFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_hhTocFdFd(MLambda,em,gs,ZcplcFdFdhhL,ZcplcFdFdhhR,             & 
& MFdOS,MhhOS,MRPhhTocFdFd,MRGhhTocFdFd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_hhTocFdFd(cplcFdFdhhL,cplcFdFdhhR,ctcplcFdFdhhL,           & 
& ctcplcFdFdhhR,MFd,MFd2,Mhh,Mhh2,ZfDL,ZfDR,Zfhh,AmpWavehhTocFdFd)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhTocFdFd(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_hhTocFdFd(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,           & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcFdFdAhL,               & 
& cplcFdFdAhR,cplAhhhhh,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,       & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFdcHmL,cplcFuFdcHmR,             & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,           & 
...
& cplhhVZVZ,AmpVertexIRdrhhTocFdFd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_hhTocFdFd(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_hhTocFeFe(cplcFeFehhL,cplcFeFehhR,MFe,Mhh,MFe2,            & 
& Mhh2,AmpTreehhTocFeFe)

  Else 
Call Amplitude_Tree_THDMII_hhTocFeFe(ZcplcFeFehhL,ZcplcFeFehhR,MFe,Mhh,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_hhTocFeFe(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,               & 
& MFeOS,MhhOS,MRPhhTocFeFe,MRGhhTocFeFe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_hhTocFeFe(MLambda,em,gs,ZcplcFeFehhL,ZcplcFeFehhR,             & 
& MFeOS,MhhOS,MRPhhTocFeFe,MRGhhTocFeFe)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_hhTocFeFe(cplcFeFehhL,cplcFeFehhR,ctcplcFeFehhL,           & 
& ctcplcFeFehhR,MFe,MFe2,Mhh,Mhh2,ZfEL,ZfER,Zfhh,AmpWavehhTocFeFe)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhTocFeFe(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,MAh2,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_hhTocFeFe(MAh,MFe,Mhh,MHm,MVP,MVWm,MVZ,               & 
...
& cplhhVZVZ,AmpVertexIRdrhhTocFeFe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_hhTocFeFe(MAhOS,MFeOS,MhhOS,MHmOS,MVP,MVWmOS,         & 
& MVZOS,MAh2OS,MFe2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,MVZ2OS,cplAhAhhh,cplcFeFeAhL,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_hhTocFuFu(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,MFu2,            & 
& Mhh2,AmpTreehhTocFuFu)

  Else 
Call Amplitude_Tree_THDMII_hhTocFuFu(ZcplcFuFuhhL,ZcplcFuFuhhR,MFu,Mhh,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_hhTocFuFu(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,               & 
& MFuOS,MhhOS,MRPhhTocFuFu,MRGhhTocFuFu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_hhTocFuFu(MLambda,em,gs,ZcplcFuFuhhL,ZcplcFuFuhhR,             & 
& MFuOS,MhhOS,MRPhhTocFuFu,MRGhhTocFuFu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_hhTocFuFu(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,           & 
& ctcplcFuFuhhR,MFu,MFu2,Mhh,Mhh2,Zfhh,ZfUL,ZfUR,AmpWavehhTocFuFu)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhTocFuFu(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_hhTocFuFu(MAh,MFd,MFu,Mhh,MHm,MVG,MVP,MVWm,           & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHm2,MVG2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplcFuFuAhL,               & 
& cplcFuFuAhR,cplAhhhhh,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcHmL,cplcFuFdcHmR,     & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,           & 
& cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,             & 
...
& cplhhVZVZ,AmpVertexIRdrhhTocFuFu)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_hhTocFuFu(MAhOS,MFdOS,MFuOS,MhhOS,MHmOS,              & 
& MVG,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHm2OS,MVG2,MVP2,MVWm2OS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_hhTohhhh(cplhhhhhh,Mhh,Mhh2,AmpTreehhTohhhh)

  Else 
Call Amplitude_Tree_THDMII_hhTohhhh(Zcplhhhhhh,Mhh,Mhh2,AmpTreehhTohhhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_hhTohhhh(MLambda,em,gs,cplhhhhhh,MhhOS,MRPhhTohhhh,            & 
& MRGhhTohhhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_hhTohhhh(MLambda,em,gs,Zcplhhhhhh,MhhOS,MRPhhTohhhh,           & 
& MRGhhTohhhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_hhTohhhh(MLambda,em,gs,cplhhhhhh,Mhh,MRPhhTohhhh,              & 
& MRGhhTohhhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_hhTohhhh(MLambda,em,gs,Zcplhhhhhh,Mhh,MRPhhTohhhh,             & 
& MRGhhTohhhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_hhTohhhh(cplhhhhhh,ctcplhhhhhh,Mhh,Mhh2,Zfhh,              & 
& AmpWavehhTohhhh)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhTohhhh(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_hhTohhhh(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,            & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplcFdFdhhL,    & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWmgWmhh,              & 
& cplcgWpCgWpChh,cplcgZgZhh,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,   & 
& cplhhVZVZ,cplAhAhhhhh1,cplAhhhhhhh1,cplhhhhhhhh1,cplhhhhHmcHm1,cplhhhhcVWmVWm1,        & 
& cplhhhhVZVZ1,AmpVertexIRdrhhTohhhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_hhTohhhh(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,               & 
& MHmOS,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVWm2OS,MVZ2OS,           & 
...
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplcFdFdhhL,    & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWmgWmhh,              & 
& cplcgWpCgWpChh,cplcgZgZhh,Zcplhhhhhh,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,               & 
& cplhhcVWmVWm,cplhhVZVZ,cplAhAhhhhh1,cplAhhhhhhh1,cplhhhhhhhh1,cplhhhhHmcHm1,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_hhTocHmHm(cplhhHmcHm,Mhh,MHm,Mhh2,MHm2,AmpTreehhTocHmHm)

  Else 
Call Amplitude_Tree_THDMII_hhTocHmHm(ZcplhhHmcHm,Mhh,MHm,Mhh2,MHm2,AmpTreehhTocHmHm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_hhTocHmHm(MLambda,em,gs,cplhhHmcHm,MhhOS,MHmOS,MRPhhTocHmHm,   & 
& MRGhhTocHmHm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_hhTocHmHm(MLambda,em,gs,ZcplhhHmcHm,MhhOS,MHmOS,               & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_hhTocHmHm(MLambda,em,gs,cplhhHmcHm,Mhh,MHm,MRPhhTocHmHm,       & 
& MRGhhTocHmHm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_hhTocHmHm(MLambda,em,gs,ZcplhhHmcHm,Mhh,MHm,MRPhhTocHmHm,      & 
& MRGhhTocHmHm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_hhTocHmHm(cplhhHmcHm,ctcplhhHmcHm,Mhh,Mhh2,MHm,            & 
& MHm2,Zfhh,ZfHm,AmpWavehhTocHmHm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhTocHmHm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_hhTocHmHm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,           & 
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,       & 
& cplAhHmcHm,cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcHmL,               & 
& cplcFuFdcHmR,cplcFeFehhL,cplcFeFehhR,cplcFvFecHmL,cplcFvFecHmR,cplcFuFuhhL,            & 
& cplcFuFuhhR,cplcFdFuHmL,cplcFdFuHmR,cplcFeFvHmL,cplcFeFvHmR,cplcgWmgWmhh,              & 
...
& cplhhcHmVWmVZ1,cplHmHmcHmcHm1,cplHmcHmcVWmVWm1,cplHmcHmVZVZ1,AmpVertexIRdrhhTocHmHm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_hhTocHmHm(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_hhToHmcVWm(cplhhHmcVWm,Mhh,MHm,MVWm,Mhh2,MHm2,             & 
& MVWm2,AmpTreehhToHmcVWm)

  Else 
Call Amplitude_Tree_THDMII_hhToHmcVWm(ZcplhhHmcVWm,Mhh,MHm,MVWm,Mhh2,MHm2,            & 
& MVWm2,AmpTreehhToHmcVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_hhToHmcVWm(MLambda,em,gs,cplhhHmcVWm,MhhOS,MHmOS,              & 
& MVWmOS,MRPhhToHmcVWm,MRGhhToHmcVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_hhToHmcVWm(MLambda,em,gs,ZcplhhHmcVWm,MhhOS,MHmOS,             & 
& MVWmOS,MRPhhToHmcVWm,MRGhhToHmcVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_hhToHmcVWm(MLambda,em,gs,cplhhHmcVWm,Mhh,MHm,MVWm,             & 
& MRPhhToHmcVWm,MRGhhToHmcVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_hhToHmcVWm(MLambda,em,gs,ZcplhhHmcVWm,Mhh,MHm,MVWm,            & 
& MRPhhToHmcVWm,MRGhhToHmcVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_hhToHmcVWm(cplhhHmcVWm,ctcplhhHmcVWm,Mhh,Mhh2,             & 
& MHm,MHm2,MVWm,MVWm2,Zfhh,ZfHm,ZfVWm,AmpWavehhToHmcVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhToHmcVWm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,             & 
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,       & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_hhToHmcVWm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,               & 
...
& AmpVertexIRdrhhToHmcVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_hhToHmcVWm(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,             & 
& MHmOS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_hhTocVWmVWm(cplhhcVWmVWm,Mhh,MVWm,Mhh2,MVWm2,              & 
& AmpTreehhTocVWmVWm)

  Else 
Call Amplitude_Tree_THDMII_hhTocVWmVWm(ZcplhhcVWmVWm,Mhh,MVWm,Mhh2,MVWm2,             & 
& AmpTreehhTocVWmVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_hhTocVWmVWm(MLambda,em,gs,cplhhcVWmVWm,MhhOS,MVWmOS,           & 
& MRPhhTocVWmVWm,MRGhhTocVWmVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_hhTocVWmVWm(MLambda,em,gs,ZcplhhcVWmVWm,MhhOS,MVWmOS,          & 
& MRPhhTocVWmVWm,MRGhhTocVWmVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_hhTocVWmVWm(MLambda,em,gs,cplhhcVWmVWm,Mhh,MVWm,               & 
& MRPhhTocVWmVWm,MRGhhTocVWmVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_hhTocVWmVWm(MLambda,em,gs,ZcplhhcVWmVWm,Mhh,MVWm,              & 
& MRPhhTocVWmVWm,MRGhhTocVWmVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_hhTocVWmVWm(cplhhcVWmVWm,ctcplhhcVWmVWm,Mhh,               & 
& Mhh2,MVWm,MVWm2,Zfhh,ZfVWm,AmpWavehhTocVWmVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhTocVWmVWm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,            & 
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,       & 
& cplAhHmcVWm,cplAhcHmVWm,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdcVWmL,cplcFuFdcVWmR,           & 
& cplcFeFehhL,cplcFeFehhR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFuFuhhL,cplcFuFuhhR,           & 
...
& cplcgZgWpCVWm,cplcgZgZhh,cplcgWmgZVWm,cplcgWpCgZcVWm,cplhhhhhh,cplhhHmcHm,             & 
& cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplhhVZVZ,cplHmcVWmVP,cplHmcVWmVZ,cplcHmVPVWm,    & 
& cplcVWmVPVWm,cplcHmVWmVZ,cplcVWmVWmVZ,cplAhAhcVWmVWm1,cplhhhhcVWmVWm1,cplhhHmcVWmVP1,  & 
& cplhhHmcVWmVZ1,cplhhcHmVPVWm1,cplhhcHmVWmVZ1,cplHmcHmcVWmVWm1,cplcVWmcVWmVWmVWm1Q,     & 
& cplcVWmcVWmVWmVWm2Q,cplcVWmcVWmVWmVWm3Q,cplcVWmVWmVZVZ2Q,cplcVWmVWmVZVZ3Q,             & 
& cplcVWmVWmVZVZ1Q,AmpVertexhhTocVWmVWm)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_hhTocVWmVWm(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,              & 
& MVWm,MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,            & 
...
& cplcVWmVWmVZVZ3Q,cplcVWmVWmVZVZ1Q,AmpVertexIRdrhhTocVWmVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_hhTocVWmVWm(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,            & 
& MHmOS,MVP,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_THDMII_hhToVZVZ(cplhhVZVZ,Mhh,MVZ,Mhh2,MVZ2,AmpTreehhToVZVZ)

  Else 
Call Amplitude_Tree_THDMII_hhToVZVZ(ZcplhhVZVZ,Mhh,MVZ,Mhh2,MVZ2,AmpTreehhToVZVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_THDMII_hhToVZVZ(MLambda,em,gs,cplhhVZVZ,MhhOS,MVZOS,MRPhhToVZVZ,      & 
& MRGhhToVZVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_THDMII_hhToVZVZ(MLambda,em,gs,ZcplhhVZVZ,MhhOS,MVZOS,MRPhhToVZVZ,     & 
& MRGhhToVZVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_THDMII_hhToVZVZ(MLambda,em,gs,cplhhVZVZ,Mhh,MVZ,MRPhhToVZVZ,          & 
& MRGhhToVZVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_THDMII_hhToVZVZ(MLambda,em,gs,ZcplhhVZVZ,Mhh,MVZ,MRPhhToVZVZ,         & 
& MRGhhToVZVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_hhToVZVZ(cplhhVZVZ,ctcplhhVZVZ,Mhh,Mhh2,MVZ,               & 
& MVZ2,Zfhh,ZfVZ,AmpWavehhToVZVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhToVZVZ(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_THDMII_hhToVZVZ(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,            & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFdFdhhL,              & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,               & 
& cplcFeFeVZR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcgWmgWmhh,              & 
& cplcgWmgWmVZ,cplcgWpCgWpChh,cplcgWpCgWpCVZ,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,           & 
...
& cplcVWmVWmVZVZ3Q,cplcVWmVWmVZVZ1Q,AmpVertexIRdrhhToVZVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_THDMII_hhToVZVZ(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,               & 
& MHmOS,MVWmOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVWm2OS,MVZ2OS,           & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_THDMII_hhToAhVP(cplAhhhVZ,ctcplAhhhVZ,MAhOS,MAh2OS,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_hhToAhVP(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,            & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_THDMII_hhToAhVP(cplAhhhVZ,ctcplAhhhVZ,MAh,MAh2,Mhh,               & 
& Mhh2,MVP,MVP2,MVZ,MVZ2,ZfAh,Zfhh,ZfVP,ZfVZVP,AmpWavehhToAhVP)



!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhToAhVP(MAh,MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,               & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_hhToFvcFv(MFeOS,MhhOS,MHmOS,MVWmOS,MVZOS,MFe2OS,         & 
& Mhh2OS,MHm2OS,MVWm2OS,MVZ2OS,cplcFeFehhL,cplcFeFehhR,cplcFvFecHmL,cplcFvFecHmR,        & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhToFvcFv(MFe,Mhh,MHm,MVWm,MVZ,MFe2,Mhh2,MHm2,           & 
& MVWm2,MVZ2,cplcFeFehhL,cplcFeFehhR,cplcFvFecHmL,cplcFvFecHmR,cplcFvFecVWmL,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_hhTohhVP(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,MVP,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhTohhVP(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MFd2,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_hhTohhVZ(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhTohhVZ(MAh,MFd,MFe,MFu,Mhh,MHm,MVWm,MVZ,               & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHm2,MVWm2,MVZ2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplcFdFdhhL,    & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,               & 
& cplcFeFeVZR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcgWmgWmhh,              & 
& cplcgWmgWmVZ,cplcgWpCgWpChh,cplcgWpCgWpCVZ,cplhhhhhh,cplhhHmcHm,cplhhHmcVWm,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_hhToVGVG(MFdOS,MFuOS,MhhOS,MVG,MFd2OS,MFu2OS,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhToVGVG(MFd,MFu,Mhh,MVG,MFd2,MFu2,Mhh2,MVG2,            & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_hhToVPVP(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,MVP,              & 
& MVWmOS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHm2OS,MVP2,MVWm2OS,cplcFdFdhhL,cplcFdFdhhR,        & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,               & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcgWmgWmhh,cplcgWmgWmVP,             & 
& cplcgWpCgWpChh,cplcgWpCgWpCVP,cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,         & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhToVPVP(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MFd2,              & 
& MFe2,MFu2,Mhh2,MHm2,MVP2,MVWm2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,        & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFuFuhhL,cplcFuFuhhR,               & 
& cplcFuFuVPL,cplcFuFuVPR,cplcgWmgWmhh,cplcgWmgWmVP,cplcgWpCgWpChh,cplcgWpCgWpCVP,       & 
& cplhhHmcHm,cplhhHmcVWm,cplhhcHmVWm,cplhhcVWmVWm,cplHmcHmVP,cplHmcVWmVP,cplcHmVPVWm,    & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_THDMII_hhToVPVZ(MFdOS,MFeOS,MFuOS,MhhOS,MHmOS,MVP,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_THDMII_hhToVPVZ(MFd,MFe,MFu,Mhh,MHm,MVP,MVWm,MVZ,               & 
...
End Module Wrapper_OneLoopDecay_hh_THDMII
