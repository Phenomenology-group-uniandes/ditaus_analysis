...
Program SPhenoTHDMII 
 
Use Control
Use InputOutput_THDMII
Use LoopFunctions
Use Settings
Use LowEnergy_THDMII
Use Mathematics
Use Model_Data_THDMII
Use Tadpoles_THDMII 
 !Use StandardModel
Use Unitarity_THDMII 
 Use Boundaries_THDMII
 Use HiggsCS_THDMII
Use TreeLevelMasses_THDMII
Use LoopMasses_THDMII
 
Use BranchingRatios_THDMII
...
& Lam2,Yu,Yd,Ye,M12,M112,M222,mGUT)
...
& Yu,Yd,Ye,M12,M112,M222,mass_uncertainty_Q)
...
& Yd,Ye,M12,M112,M222,vd,vu,Tpar,Spar,Upar,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,           & 
...
& Lam1,Lam4,Lam3,Lam2,Yu,Yd,Ye,M12,M112,M222,kont)
...
& betaH,g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Yu,Yd,Ye,M12,M112,M222,mGut,kont,              & 
& WriteOut,n_run)
...
End if 
Call GToParameters75(gD,g1,g2,g3,Lam5,Lam1,Lam4,Lam3,Lam2,Yu,Yd,Ye,M12,               & 
& M112,M222,vd,vu)
