...
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMassesTHDM-II-v2'
...
mat(1,1) = mat(1,1)+(Lam3*vu**2)/2._dp
mat(1,1) = mat(1,1)+(Lam4*vu**2)/2._dp
mat(1,1) = mat(1,1)-1._dp/4._dp*(Lam5*vu**2)
mat(1,1) = mat(1,1)-1._dp/4._dp*(vu**2*Conjg(Lam5))
...
mat(2,2) = mat(2,2)+(Lam3*vd**2)/2._dp
mat(2,2) = mat(2,2)+(Lam4*vd**2)/2._dp
mat(2,2) = mat(2,2)-1._dp/4._dp*(Lam5*vd**2)
mat(2,2) = mat(2,2)+Lam2*vu**2
mat(2,2) = mat(2,2)-1._dp/4._dp*(vd**2*Conjg(Lam5))
...
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)-1._dp/4._dp*(g1*g2*vd**2)
mat(1,2) = mat(1,2)-1._dp/4._dp*(g1*g2*vu**2)
mat(2,2) = 0._dp 
...
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)-1._dp/4._dp*(g1*g2*vdFix**2)
mat(1,2) = mat(1,2)-1._dp/4._dp*(g1*g2*vuFix**2)
mat(2,2) = 0._dp 
...
End Module TreeLevelMasses_THDMII 
