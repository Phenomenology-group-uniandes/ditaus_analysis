...
V_325 = Vertex(name = 'V_325',
    ...
    color = ['Identity(1,2)'],
    lorentz = [L.FFV2,L.FFV3],
    couplings = {(0,1):C.GC_477,(0,0):C.GC_478})
...
V_340 = Vertex(name = 'V_340',
    ...
    color = ['1'],
    lorentz = [L.FFV2,L.FFV3],
    couplings = {(0,1):C.GC_498,(0,0):C.GC_499})
...
V_367 = Vertex(name = 'V_367',
    ...
    color = ['Identity(1,2)'],
    lorentz = [L.FFV2,L.FFV3],
    couplings = {(0,1):C.GC_534,(0,0):C.GC_535})
...
V_383 = Vertex(name = 'V_383',
    ...
    couplings = {(0,0):C.GC_551,(1,0):C.GC_552,(0,1):C.GC_553,(2,1):C.GC_554,(1,2):C.GC_555,(2,2):C.GC_556})
...
V_384 = Vertex(name = 'V_384',
    ...
    color = ['1'],
    lorentz = [L.VVVV1,L.VVVV2,L.VVVV3],
    couplings = {(0,0):C.GC_557,(0,1):C.GC_558,(0,2):C.GC_559})
...
V_385 = Vertex(name = 'V_385',
    ...
    color = ['1'],
    lorentz = [L.VVVV1,L.VVVV2,L.VVVV3],
    couplings = {(0,0):C.GC_560,(0,1):C.GC_561,(0,2):C.GC_562})
...
V_386 = Vertex(name = 'V_386',
    ...
    color = ['1'],
    lorentz = [L.VVVV1,L.VVVV2,L.VVVV3],
    couplings = {(0,0):C.GC_563,(0,1):C.GC_564,(0,2):C.GC_565})
...
V_387 = Vertex(name = 'V_387',
    ...
    color = ['1'],
    lorentz = [L.VVVV1,L.VVVV2,L.VVVV3],
    couplings = {(0,0):C.GC_566,(0,1):C.GC_567,(0,2):C.GC_568})
