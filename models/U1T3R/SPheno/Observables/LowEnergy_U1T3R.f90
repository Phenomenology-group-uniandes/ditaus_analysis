...
Use StandardModel 
Use RunSM_U1T3R
Use FlavorKit_LFV_U1T3R
Use FlavorKit_QFV_U1T3R
Use FlavorKit_Observables_U1T3R
...
& OA2lSLSM(3,3),OA2lSRSM(3,3),OA1LSM(3,3),OA1RSM(3,3),OH2lSLSM(3,3,2),OH2lSRSM(3,3,2),   & 
...
& OH2lSR(3,3,2),DP2lSL(3,3),DP2lSR(3,3),OZ2lSL(3,3),OZ2lSR(3,3),OZ2lVL(3,3),             & 
& OZ2lVR(3,3)
...
& OH2lSRcheck(3,3,2),DP2lSLcheck(3,3),DP2lSRcheck(3,3),OZ2lSLcheck(3,3),OZ2lSRcheck(3,3),& 
...
& MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,          & 
& cplAhcHpVWp,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpcVWp,cplcFdFdAhL,cplcFdFdAhR,        & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,              & 
& cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,        & 
...
& cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcHpVPVWp,cplcHpVWpVZ,             & 
& cplcHpVWpVZp,cplcVWpVPVWp,cplcVWpVWpVZ,cplcVWpVWpVZp,cplFvFeHpL,cplFvFeHpR,            & 
& cplFvFeVWpL,cplFvFeVWpR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,        & 
& cplFvFvVPR,cplFvFvVZL,cplFvFvVZpL,cplFvFvVZpR,cplFvFvVZR,cplhhcHpVWp,cplhhcVWpVWp,     & 
& cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,           & 
& cplhhVZVZp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVP,cplHpcVWpVZ,cplHpcVWpVZp,     & 
...
& cplAhAhhh,cplAhcHpVWp,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpcVWp,cplcFdFdAhL,          & 
& cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
& cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,         & 
& cplcFdFucVWpR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,             & 
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,cplcFeFvcHpL,            & 
...
& cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcHpVPVWp,             & 
& cplcHpVWpVZ,cplcHpVWpVZp,cplcVWpVPVWp,cplcVWpVWpVZ,cplcVWpVWpVZp,cplFvFeHpL,           & 
& cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,        & 
& cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZpL,cplFvFvVZpR,cplFvFvVZR,cplhhcHpVWp,       & 
& cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVP,cplHpcVWpVZ,        & 
& cplHpcVWpVZp,TSOddvvVRR(gt1,gt2,gt3,gt4),TSOddvvVLL(gt1,gt2,gt3,gt4),TSOddvvVRL(gt1,gt2,gt3,gt4)& 
...
& cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVP,cplHpcVWpVZ,        & 
& cplHpcVWpVZp,TVOddvvVRR(gt1,gt2,gt3,gt4),TVOddvvVLL(gt1,gt2,gt3,gt4),TVOddvvVRL(gt1,gt2,gt3,gt4)& 
...
& cplAhhhVZ,cplAhhhVZp,cplAhHpcVWp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,      & 
...
& cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcHpVPVWp,cplcHpVWpVZ,             & 
& cplcHpVWpVZp,cplcVWpVPVWp,cplcVWpVWpVZ,cplcVWpVWpVZp,cplhhcHpVWp,cplhhcVWpVWp,         & 
& cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,           & 
& cplhhVZVZp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVP,cplHpcVWpVZ,cplHpcVWpVZp,     & 
...
& MFu,MFu2,MFv,MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhcHpVWp,        & 
& cplAhHpcVWp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,               & 
& cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,         & 
& cplcFdFucVWpR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,             & 
& cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,         & 
...
& cplcFuFuVZR,cplcHpVWpVZ,cplcHpVWpVZp,cplcVWpVWpVZ,cplcVWpVWpVZp,cplFvFeHpL,            & 
& cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,        & 
& cplFvFvVZL,cplFvFvVZpL,cplFvFvVZpR,cplFvFvVZR,cplhhcHpVWp,cplhhcVWpVWp,cplhhHpcHp,     & 
& cplhhHpcVWp,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVZ,cplHpcVWpVZp,TSOdulvSLL(gt1,gt2,gt3,gt4)& 
...
& cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,        & 
& cplFvFvVZL,cplFvFvVZpL,cplFvFvVZpR,cplFvFvVZR,cplhhcHpVWp,cplhhcVWpVWp,cplhhHpcHp,     & 
& cplhhHpcVWp,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVZ,cplHpcVWpVZp,TVOdulvSLL(gt1,gt2,gt3,gt4)& 
...
& cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVP,cplHpcVWpVZ,        & 
& cplHpcVWpVZp,PSOddvvVRR(gt1,gt2,gt3,gt4),PSOddvvVLL(gt1,gt2,gt3,gt4),PSOddvvVRL(gt1,gt2,gt3,gt4)& 
...
& cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVP,cplHpcVWpVZ,        & 
& cplHpcVWpVZp,PVOddvvVRR(gt1,gt2,gt3,gt4),PVOddvvVLL(gt1,gt2,gt3,gt4),PVOddvvVRL(gt1,gt2,gt3,gt4)& 
...
& MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhcHpVWp,cplAhhhVZ,               & 
& cplAhhhVZp,cplAhHpcVWp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,    & 
& cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,         & 
& cplcFdFucVWpR,cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuAhL,           & 
...
& Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhhhVP,cplcFdFdAhL,cplcFdFdAhR,        & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,              & 
& cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,        & 
& cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuVPL,cplcFuFuVPR,             & 
& cplcHpVPVWp,cplcVWpVPVWp,cplhhVPVZ,cplhhVPVZp,cplHpcHpVP,cplHpcVWpVP,OA2qSL(gt1,gt2)   & 
...
& Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,      & 
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,             & 
& cplcFdFdVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFuFdHpL,         & 
& cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuVGL,cplcFuFuVGR,OG2qSL(gt1,gt2)          & 
& ,OG2qSR(gt1,gt2))
...
& MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhhhVZ,cplAhhhVZp,cplcFdFdAhL,    & 
& cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,             & 
& cplcFdFdVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFuFdHpL,         & 
& cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuhhL,cplcFuFuhhR,cplhhcHpVWp,             & 
& cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,        & 
...
& cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,        & 
& cplFvFvVZL,cplFvFvVZpL,cplFvFvVZpR,cplFvFvVZR,cplhhcHpVWp,cplhhcVWpVWp,cplhhHpcHp,     & 
& cplhhHpcVWp,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVZ,cplHpcVWpVZp,TSOdulvSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,        & 
& cplFvFvVZL,cplFvFvVZpL,cplFvFvVZpR,cplFvFvVZR,cplhhcHpVWp,cplhhcVWpVWp,cplhhHpcHp,     & 
& cplhhHpcVWp,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVZ,cplHpcVWpVZp,TVOdulvSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,        & 
& cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuVPL,cplcFuFuVPR,             & 
& cplcHpVPVWp,cplcVWpVPVWp,cplhhVPVZ,cplhhVPVZp,cplHpcHpVP,cplHpcVWpVP,OA2qSLSM(gt1,gt2) & 
...
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,             & 
& cplcFdFdVZR,cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFuFdHpL,         & 
& cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuVGL,cplcFuFuVGR,OG2qSLSM(gt1,gt2)        & 
& ,OG2qSRSM(gt1,gt2))
...
& Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhcHpVWp,cplAhhhVP,      & 
& cplAhhhVZ,cplAhhhVZp,cplAhHpcVWp,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,      & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,             & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcHpVPVWp,cplcHpVWpVZ,         & 
& cplcHpVWpVZp,cplcVWpVPVWp,cplcVWpVWpVZ,cplcVWpVWpVZp,cplFvFeHpL,cplFvFeHpR,            & 
& cplFvFeVWpL,cplFvFeVWpR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,cplFvFvVPL,        & 
& cplFvFvVPR,cplFvFvVZL,cplFvFvVZpL,cplFvFvVZpR,cplFvFvVZR,cplhhcHpVWp,cplhhcVWpVWp,     & 
& cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,           & 
...
& MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhcHpVWp,           & 
& cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpcVWp,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,        & 
& cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,             & 
& cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcHpVPVWp,         & 
& cplcHpVWpVZ,cplcHpVWpVZp,cplcVWpVPVWp,cplcVWpVWpVZ,cplcVWpVWpVZp,cplFvFeHpL,           & 
& cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvAhL,cplFvFvAhR,cplFvFvhhL,cplFvFvhhR,        & 
& cplFvFvVPL,cplFvFvVPR,cplFvFvVZL,cplFvFvVZpL,cplFvFvVZpR,cplFvFvVZR,cplhhcHpVWp,       & 
& cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVP,cplHpcVWpVZ,        & 
& cplHpcVWpVZp,TSO4lSLLcross(gt1,gt2,gt3,gt4),TSO4lSRRcross(gt1,gt2,gt3,gt4)             & 
...
& cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVP,cplHpcVWpVZ,        & 
& cplHpcVWpVZp,TSO4lSLLcrossSM(gt1,gt2,gt3,gt4),TSO4lSRRcrossSM(gt1,gt2,gt3,gt4)         & 
...
& cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVP,cplHpcVWpVZ,        & 
& cplHpcVWpVZp,TVO4lSLLcross(gt1,gt2,gt3,gt4),TVO4lSRRcross(gt1,gt2,gt3,gt4)             & 
...
& cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVP,cplHpcVWpVZ,        & 
& cplHpcVWpVZp,TVO4lSLLcrossSM(gt1,gt2,gt3,gt4),TVO4lSRRcrossSM(gt1,gt2,gt3,gt4)         & 
...
& cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVP,cplHpcVWpVZ,        & 
& cplHpcVWpVZp,BO4lSLLcross(gt1,gt2,gt3,gt4),BO4lSRRcross(gt1,gt2,gt3,gt4)               & 
...
& cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVP,cplHpcVWpVZ,        & 
& cplHpcVWpVZp,PSO4lSLLcross(gt1,gt2,gt3,gt4),PSO4lSRRcross(gt1,gt2,gt3,gt4)             & 
...
& cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVP,cplHpcVWpVZ,        & 
& cplHpcVWpVZp,PSO4lSLLcrossSM(gt1,gt2,gt3,gt4),PSO4lSRRcrossSM(gt1,gt2,gt3,gt4)         & 
...
& cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVP,cplHpcVWpVZ,        & 
& cplHpcVWpVZp,PVO4lSLLcross(gt1,gt2,gt3,gt4),PVO4lSRRcross(gt1,gt2,gt3,gt4)             & 
...
& cplhhcVWpVWp,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,        & 
& cplhhVZVZ,cplhhVZVZp,cplHpcHpVP,cplHpcHpVZ,cplHpcHpVZp,cplHpcVWpVP,cplHpcVWpVZ,        & 
& cplHpcVWpVZp,PVO4lSLLcrossSM(gt1,gt2,gt3,gt4),PVO4lSRRcrossSM(gt1,gt2,gt3,gt4)         & 
...
& Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhhhVP,cplcFeFeAhL,cplcFeFeAhR,        & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZpL,              & 
& cplcFeFeVZpR,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,        & 
& cplcHpVPVWp,cplcVWpVPVWp,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVPL,     & 
& cplFvFvVPR,cplhhVPVZ,cplhhVPVZp,cplHpcHpVP,cplHpcVWpVP,OA2lSL(gt1,gt2),OA2lSR(gt1,gt2) & 
...
& cplcFeFeVZpR,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,        & 
& cplcHpVPVWp,cplcVWpVPVWp,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVPL,     & 
& cplFvFvVPR,cplhhVPVZ,cplhhVPVZp,cplHpcHpVP,cplHpcVWpVP,OA2lSLSM(gt1,gt2)               & 
...
& MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhhhVZ,cplAhhhVZp,cplcFeFeAhL,    & 
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,             & 
& cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplFvFeHpL,          & 
& cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvhhL,cplFvFvhhR,cplhhcHpVWp,cplhhcVWpVWp,     & 
& cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,OH2lSL(gt1,gt2,gt3)  & 
& ,OH2lSR(gt1,gt2,gt3))
...
& cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplFvFeHpL,          & 
& cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvhhL,cplFvFvhhR,cplhhcHpVWp,cplhhcVWpVWp,     & 
& cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,OH2lSLSM(gt1,gt2,gt3)& 
...
& MFv2,Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhhhVP,cplcFeFeAhL,           & 
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,               & 
& cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,         & 
& cplcFeFvcVWpR,cplcHpVPVWp,cplcVWpVPVWp,cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,              & 
& cplFvFeVWpR,cplFvFvVPL,cplFvFvVPR,cplhhVPVZ,cplhhVPVZp,cplHpcHpVP,cplHpcVWpVP,         & 
...
& MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhhhVZ,cplcFeFeAhL,cplcFeFeAhR,             & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,             & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcHpVWpVZ,cplcVWpVWpVZ,        & 
& cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,         & 
& cplhhVZVZp,cplHpcHpVZ,cplHpcVWpVZ,OZ2lSL(gt1,gt2),OZ2lSR(gt1,gt2),OZ2lVL(gt1,gt2)      & 
& ,OZ2lVR(gt1,gt2))
...
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcHpVWpVZ,cplcVWpVWpVZ,        & 
& cplFvFeHpL,cplFvFeHpR,cplFvFeVWpL,cplFvFeVWpR,cplFvFvVZL,cplFvFvVZR,cplhhVZVZ,         & 
& cplhhVZVZp,cplHpcHpVZ,cplHpcVWpVZ,OZ2lSLSM(gt1,gt2),OZ2lSRSM(gt1,gt2),OZ2lVLSM(gt1,gt2)& 
& ,OZ2lVRSM(gt1,gt2))
