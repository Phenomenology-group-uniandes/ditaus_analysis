...
Contains 
 ...
 Subroutine RunSM_and_SUSY_RGEs(Qout,g1input,g1Xinput,g2input,g3input,gXinput,         & 
...
& vH,vPhi,CKMout,sinW2_out,Alpha_out,AlphaS_out,realCKM)
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(229), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG229(g1input,g1Xinput,g2input,g3input,gXinput,gX1input,              & 
...
& mu2Hinput,mu2Phiinput,vHinput,vPhiinput,g1D)

Call GToParameters229(g1D,g1,g1X,g2,g3,gX,gX1,LamH,LamPhiH,LamPhi,YvL,YuL,            & 
