...
GC_19 = Coupling(name = 'GC_19',
                 value = '(complex(0,1)*gZp*I5a11)/(2.*cmath.sqrt(6))',
                 order = {'NP':1})

GC_20 = Coupling(name = 'GC_20',
                 value = '(complex(0,1)*gZp*I5a12)/(2.*cmath.sqrt(6))',
                 order = {'NP':1})

GC_21 = Coupling(name = 'GC_21',
                 value = '(complex(0,1)*gZp*I5a13)/(2.*cmath.sqrt(6))',
                 order = {'NP':1})

GC_22 = Coupling(name = 'GC_22',
                 value = '(complex(0,1)*gZp*I5a21)/(2.*cmath.sqrt(6))',
                 order = {'NP':1})

GC_23 = Coupling(name = 'GC_23',
                 value = '(complex(0,1)*gZp*I5a22)/(2.*cmath.sqrt(6))',
                 order = {'NP':1})

GC_24 = Coupling(name = 'GC_24',
                 value = '(complex(0,1)*gZp*I5a23)/(2.*cmath.sqrt(6))',
                 order = {'NP':1})

GC_25 = Coupling(name = 'GC_25',
                 value = '(complex(0,1)*gZp*I5a31)/(2.*cmath.sqrt(6))',
                 order = {'NP':1})

GC_26 = Coupling(name = 'GC_26',
                 value = '(complex(0,1)*gZp*I5a32)/(2.*cmath.sqrt(6))',
                 order = {'NP':1})

GC_27 = Coupling(name = 'GC_27',
                 value = '(complex(0,1)*gZp*I5a33)/(2.*cmath.sqrt(6))',
                 order = {'NP':1})
