...
WS1t = Parameter(name = 'WS1t',
                 nature = 'internal',
                 type = 'real',
                 value = '(MS1t*(abs(yRR1x1)**2 + abs(yRR1x2)**2 + abs(yRR1x3)**2 + abs(yRR2x1)**2 + abs(yRR2x2)**2 + abs(yRR2x3)**2 + abs(yRR3x1)**2 + abs(yRR3x2)**2 + abs(yRR3x3)**2))/(16.*cmath.pi)',
                 texname = '\\text{WS1t}')
